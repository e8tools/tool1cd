...
#undef afkLanguageCode
#undef afkLanguageCode_4_0
...
#undef ArabicShaping
#undef armiScriptCode
#undef armiScriptCode_4_0
#undef B_M_SEARCH_H
...
#undef pl_addFontRun
#undef pl_addFontRun_4_0
#undef pl_addLocaleRun
#undef pl_addLocaleRun_4_0
#undef pl_addValueRun
#undef pl_addValueRun_4_0
#undef pl_close
#undef pl_close_4_0
#undef pl_closeFontRuns
#undef pl_closeFontRuns_4_0
#undef pl_closeLine
#undef pl_closeLine_4_0
#undef pl_closeLocaleRuns
#undef pl_closeLocaleRuns_4_0
#undef pl_closeValueRuns
#undef pl_closeValueRuns_4_0
#undef pl_countLineRuns
#undef pl_countLineRuns_4_0
#undef pl_create
#undef pl_create_4_0
#undef pl_getAscent
#undef pl_getAscent_4_0
#undef pl_getDescent
#undef pl_getDescent_4_0
#undef pl_getFontRunCount
#undef pl_getFontRunCount_4_0
#undef pl_getFontRunFont
#undef pl_getFontRunFont_4_0
#undef pl_getFontRunLastLimit
#undef pl_getFontRunLastLimit_4_0
#undef pl_getFontRunLimit
#undef pl_getFontRunLimit_4_0
#undef pl_getLeading
#undef pl_getLeading_4_0
#undef pl_getLineAscent
#undef pl_getLineAscent_4_0
#undef pl_getLineDescent
#undef pl_getLineDescent_4_0
#undef pl_getLineLeading
#undef pl_getLineLeading_4_0
#undef pl_getLineVisualRun
#undef pl_getLineVisualRun_4_0
#undef pl_getLineWidth
#undef pl_getLineWidth_4_0
#undef pl_getLocaleRunCount
#undef pl_getLocaleRunCount_4_0
#undef pl_getLocaleRunLastLimit
#undef pl_getLocaleRunLastLimit_4_0
#undef pl_getLocaleRunLimit
#undef pl_getLocaleRunLimit_4_0
#undef pl_getLocaleRunLocale
#undef pl_getLocaleRunLocale_4_0
#undef pl_getParagraphLevel
#undef pl_getParagraphLevel_4_0
#undef pl_getTextDirection
#undef pl_getTextDirection_4_0
#undef pl_getValueRunCount
#undef pl_getValueRunCount_4_0
#undef pl_getValueRunLastLimit
#undef pl_getValueRunLastLimit_4_0
#undef pl_getValueRunLimit
#undef pl_getValueRunLimit_4_0
#undef pl_getValueRunValue
#undef pl_getValueRunValue_4_0
#undef pl_getVisualRunAscent
#undef pl_getVisualRunAscent_4_0
#undef pl_getVisualRunDescent
#undef pl_getVisualRunDescent_4_0
#undef pl_getVisualRunDirection
#undef pl_getVisualRunDirection_4_0
#undef pl_getVisualRunFont
#undef pl_getVisualRunFont_4_0
#undef pl_getVisualRunGlyphCount
#undef pl_getVisualRunGlyphCount_4_0
#undef pl_getVisualRunGlyphs
#undef pl_getVisualRunGlyphs_4_0
#undef pl_getVisualRunGlyphToCharMap
#undef pl_getVisualRunGlyphToCharMap_4_0
#undef pl_getVisualRunLeading
#undef pl_getVisualRunLeading_4_0
#undef pl_getVisualRunPositions
#undef pl_getVisualRunPositions_4_0
#undef pl_isComplex
#undef pl_isComplex_4_0
#undef pl_line
#undef pl_line_4_0
#undef pl_nextLine
#undef pl_nextLine_4_0
#undef pl_openEmptyFontRuns
#undef pl_openEmptyFontRuns_4_0
#undef pl_openEmptyLocaleRuns
#undef pl_openEmptyLocaleRuns_4_0
#undef pl_openEmptyValueRuns
#undef pl_openEmptyValueRuns_4_0
#undef pl_openFontRuns
#undef pl_openFontRuns_4_0
#undef pl_openLocaleRuns
#undef pl_openLocaleRuns_4_0
#undef pl_openValueRuns
#undef pl_openValueRuns_4_0
#undef pl_paragraph
#undef pl_paragraph_4_0
#undef pl_reflow
#undef pl_reflow_4_0
#undef pl_resetFontRuns
#undef pl_resetFontRuns_4_0
#undef pl_resetLocaleRuns
#undef pl_resetLocaleRuns_4_0
#undef pl_resetValueRuns
#undef pl_resetValueRuns_4_0
#undef pl_visualRun
#undef pl_visualRun_4_0
#undef PluralFormat
...
#undef u_fgetcodepage_4_0
#undef u_fgetConverter
#undef u_fgetConverter_4_0
#undef u_fgetcx
#undef u_fgetcx_4_0
#undef u_fgetfile
#undef u_fgetfile_4_0
#undef u_fgetlocale
#undef u_fgetlocale_4_0
#undef u_fgets
#undef u_fgets_4_0
#undef U_FILE_ALT_SEP_CHAR
#undef U_FILE_ALT_SEP_STRING
#undef u_file_read
#undef u_file_read_4_0
#undef U_FILE_SEP_CHAR
#undef U_FILE_SEP_STRING
#undef u_file_write
#undef u_file_write_4_0
...
#undef u_fscanf_4_0
#undef u_fscanf_u
#undef u_fscanf_u_4_0
#undef u_fsetcodepage
#undef u_fsetcodepage_4_0
#undef u_fsetlocale
#undef u_fsetlocale_4_0
#undef u_fsettransliterator
#undef u_fsettransliterator_4_0
#undef u_fstropen
#undef u_fstropen_4_0
#undef u_fungetc
#undef u_fungetc_4_0
#undef U_GC_C_MASK
#undef U_GC_CC_MASK
...
#undef u_setAtomicIncDecFunctions_4_0
#undef u_setDataDirectory
#undef u_setMemoryFunctions
#undef u_setMemoryFunctions_4_0
#undef u_setMutexFunctions
#undef u_setMutexFunctions_4_0
...
#undef u_snprintf
#undef u_snprintf_4_0
#undef u_snprintf_u
#undef u_snprintf_u_4_0
#undef u_sprintf
#undef u_sprintf_4_0
#undef u_sprintf_u
#undef u_sprintf_u_4_0
#undef u_sscanf
#undef u_sscanf_4_0
#undef u_sscanf_u
#undef u_sscanf_u_4_0
#undef U_STABLE
...
#undef u_vfprintf
#undef u_vfprintf_4_0
#undef u_vfprintf_u
#undef u_vfprintf_u_4_0
#undef u_vfscanf
#undef u_vfscanf_4_0
#undef u_vfscanf_u
#undef u_vfscanf_u_4_0
#undef u_vparseMessage
#undef u_vparseMessageWithError
#undef u_vsnprintf
#undef u_vsnprintf_4_0
#undef u_vsnprintf_u
#undef u_vsnprintf_u_4_0
#undef u_vsprintf
#undef u_vsprintf_4_0
#undef u_vsprintf_u
#undef u_vsprintf_u_4_0
#undef u_vsscanf
#undef u_vsscanf_4_0
#undef u_vsscanf_u
#undef u_vsscanf_u_4_0
...
#undef ucal_getCanonicalTimeZoneID_4_0
...
#undef ucol_prepareShortStringOpen_4_0
#undef ucol_previous
#undef ucol_previousProcessed
#undef ucol_previousProcessed_4_0
...
#undef ucurr_countCurrencies_4_0
#undef ucurr_forLocale
#undef ucurr_forLocaleAndDate
#undef ucurr_forLocaleAndDate_4_0
...
#undef uloc_addLikelySubtags_4_0
#undef ULOC_CANADA
...
#undef uloc_getCharacterOrientation_4_0
#undef uloc_getCountry
#undef uloc_getDefault
#undef uloc_getDefault_4_0
...
#undef uloc_getLineOrientation_4_0
...
#undef uprv_getDefaultCodepage_4_0
#undef uprv_getDefaultLocaleID
#undef uprv_getDefaultLocaleID_4_0
...
#undef uregex_getMatchCallback_4_0
#undef uregex_getStackLimit
#undef uregex_getStackLimit_4_0
#undef uregex_getText
#undef uregex_getTimeLimit
#undef uregex_getTimeLimit_4_0
#undef uregex_group
#undef uregex_groupCount
#undef UREGEX_H
#undef uregex_hasAnchoringBounds
#undef uregex_hasAnchoringBounds_4_0
#undef uregex_hasTransparentBounds
#undef uregex_hasTransparentBounds_4_0
#undef uregex_hitEnd
#undef uregex_hitEnd_4_0
...
#undef ures_getVersionNumber_4_0
#undef URES_H
#undef ures_hasNext
...
#undef usearch_search_4_0
#undef usearch_searchBackwards
#undef usearch_searchBackwards_4_0
...
#undef utf8_appendCharSafeBody_4_0
...
#undef utrans_getAvailableID_4_0
#undef utrans_getID
#undef utrans_getID_4_0
#undef utrans_getUnicodeID
#undef UTRANS_H
#undef utrans_open
#undef utrans_open_4_0
...
#define U_AMBIGUOUS_ALIAS_WARNING U_AMBIGUOUS_ALIAS_WARNING_4_0_
#undef U_ARABIC_NUMBER
#define U_ARABIC_NUMBER U_ARABIC_NUMBER_4_0_
#undef U_ARGUMENT_TYPE_MISMATCH
#define U_ARGUMENT_TYPE_MISMATCH U_ARGUMENT_TYPE_MISMATCH_4_0_
#undef U_BAD_VARIABLE_DEFINITION
#define U_BAD_VARIABLE_DEFINITION U_BAD_VARIABLE_DEFINITION_4_0_
#undef U_BLOCK_SEPARATOR
#define U_BLOCK_SEPARATOR U_BLOCK_SEPARATOR_4_0_
#undef U_BOUNDARY_NEUTRAL
#define U_BOUNDARY_NEUTRAL U_BOUNDARY_NEUTRAL_4_0_
#undef U_BRK_ASSIGN_ERROR
#define U_BRK_ASSIGN_ERROR U_BRK_ASSIGN_ERROR_4_0_
#undef U_BRK_ERROR_LIMIT
#define U_BRK_ERROR_LIMIT U_BRK_ERROR_LIMIT_4_0_
#undef U_BRK_ERROR_START
#define U_BRK_ERROR_START U_BRK_ERROR_START_4_0_
#undef U_BRK_HEX_DIGITS_EXPECTED
#define U_BRK_HEX_DIGITS_EXPECTED U_BRK_HEX_DIGITS_EXPECTED_4_0_
#undef U_BRK_INIT_ERROR
#define U_BRK_INIT_ERROR U_BRK_INIT_ERROR_4_0_
#undef U_BRK_INTERNAL_ERROR
#define U_BRK_INTERNAL_ERROR U_BRK_INTERNAL_ERROR_4_0_
#undef U_BRK_MALFORMED_RULE_TAG
#define U_BRK_MALFORMED_RULE_TAG U_BRK_MALFORMED_RULE_TAG_4_0_
#undef U_BRK_MISMATCHED_PAREN
#define U_BRK_MISMATCHED_PAREN U_BRK_MISMATCHED_PAREN_4_0_
#undef U_BRK_NEW_LINE_IN_QUOTED_STRING
#define U_BRK_NEW_LINE_IN_QUOTED_STRING U_BRK_NEW_LINE_IN_QUOTED_STRING_4_0_
#undef U_BRK_RULE_EMPTY_SET
#define U_BRK_RULE_EMPTY_SET U_BRK_RULE_EMPTY_SET_4_0_
#undef U_BRK_RULE_SYNTAX
#define U_BRK_RULE_SYNTAX U_BRK_RULE_SYNTAX_4_0_
#undef U_BRK_SEMICOLON_EXPECTED
#define U_BRK_SEMICOLON_EXPECTED U_BRK_SEMICOLON_EXPECTED_4_0_
#undef U_BRK_UNCLOSED_SET
#define U_BRK_UNCLOSED_SET U_BRK_UNCLOSED_SET_4_0_
#undef U_BRK_UNDEFINED_VARIABLE
#define U_BRK_UNDEFINED_VARIABLE U_BRK_UNDEFINED_VARIABLE_4_0_
#undef U_BRK_UNRECOGNIZED_OPTION
#define U_BRK_UNRECOGNIZED_OPTION U_BRK_UNRECOGNIZED_OPTION_4_0_
#undef U_BRK_VARIABLE_REDFINITION
#define U_BRK_VARIABLE_REDFINITION U_BRK_VARIABLE_REDFINITION_4_0_
#undef U_BUFFER_OVERFLOW_ERROR
#define U_BUFFER_OVERFLOW_ERROR U_BUFFER_OVERFLOW_ERROR_4_0_
#undef U_CE_NOT_FOUND_ERROR
#define U_CE_NOT_FOUND_ERROR U_CE_NOT_FOUND_ERROR_4_0_
#undef U_CHAR_CATEGORY_COUNT
#define U_CHAR_CATEGORY_COUNT U_CHAR_CATEGORY_COUNT_4_0_
#undef U_CHAR_DIRECTION_COUNT
#define U_CHAR_DIRECTION_COUNT U_CHAR_DIRECTION_COUNT_4_0_
#undef U_CHAR_NAME_CHOICE_COUNT
#define U_CHAR_NAME_CHOICE_COUNT U_CHAR_NAME_CHOICE_COUNT_4_0_
#undef U_COLLATOR_VERSION_MISMATCH
#define U_COLLATOR_VERSION_MISMATCH U_COLLATOR_VERSION_MISMATCH_4_0_
#undef U_COMBINING_SPACING_MARK
#define U_COMBINING_SPACING_MARK U_COMBINING_SPACING_MARK_4_0_
#undef U_COMMON_NUMBER_SEPARATOR
#define U_COMMON_NUMBER_SEPARATOR U_COMMON_NUMBER_SEPARATOR_4_0_
#undef U_CONNECTOR_PUNCTUATION
#define U_CONNECTOR_PUNCTUATION U_CONNECTOR_PUNCTUATION_4_0_
#undef U_CONTROL_CHAR
#define U_CONTROL_CHAR U_CONTROL_CHAR_4_0_
#undef U_CURRENCY_SYMBOL
#define U_CURRENCY_SYMBOL U_CURRENCY_SYMBOL_4_0_
#undef U_DASH_PUNCTUATION
#define U_DASH_PUNCTUATION U_DASH_PUNCTUATION_4_0_
#undef U_DECIMAL_DIGIT_NUMBER
#define U_DECIMAL_DIGIT_NUMBER U_DECIMAL_DIGIT_NUMBER_4_0_
#undef U_DEFAULT_KEYWORD_MISSING
#define U_DEFAULT_KEYWORD_MISSING U_DEFAULT_KEYWORD_MISSING_4_0_
#undef U_DIFFERENT_UCA_VERSION
#define U_DIFFERENT_UCA_VERSION U_DIFFERENT_UCA_VERSION_4_0_
#undef U_DIR_NON_SPACING_MARK
#define U_DIR_NON_SPACING_MARK U_DIR_NON_SPACING_MARK_4_0_
#undef U_DT_CANONICAL
#define U_DT_CANONICAL U_DT_CANONICAL_4_0_
#undef U_DT_CIRCLE
#define U_DT_CIRCLE U_DT_CIRCLE_4_0_
#undef U_DT_COMPAT
#define U_DT_COMPAT U_DT_COMPAT_4_0_
#undef U_DT_COUNT
#define U_DT_COUNT U_DT_COUNT_4_0_
#undef U_DT_FINAL
#define U_DT_FINAL U_DT_FINAL_4_0_
#undef U_DT_FONT
#define U_DT_FONT U_DT_FONT_4_0_
#undef U_DT_FRACTION
#define U_DT_FRACTION U_DT_FRACTION_4_0_
#undef U_DT_INITIAL
#define U_DT_INITIAL U_DT_INITIAL_4_0_
#undef U_DT_ISOLATED
#define U_DT_ISOLATED U_DT_ISOLATED_4_0_
#undef U_DT_MEDIAL
#define U_DT_MEDIAL U_DT_MEDIAL_4_0_
#undef U_DT_NARROW
#define U_DT_NARROW U_DT_NARROW_4_0_
#undef U_DT_NOBREAK
#define U_DT_NOBREAK U_DT_NOBREAK_4_0_
#undef U_DT_NONE
#define U_DT_NONE U_DT_NONE_4_0_
#undef U_DT_SMALL
#define U_DT_SMALL U_DT_SMALL_4_0_
#undef U_DT_SQUARE
#define U_DT_SQUARE U_DT_SQUARE_4_0_
#undef U_DT_SUB
#define U_DT_SUB U_DT_SUB_4_0_
#undef U_DT_SUPER
#define U_DT_SUPER U_DT_SUPER_4_0_
#undef U_DT_VERTICAL
#define U_DT_VERTICAL U_DT_VERTICAL_4_0_
#undef U_DT_WIDE
#define U_DT_WIDE U_DT_WIDE_4_0_
#undef U_DUPLICATE_KEYWORD
#define U_DUPLICATE_KEYWORD U_DUPLICATE_KEYWORD_4_0_
#undef U_EA_AMBIGUOUS
#define U_EA_AMBIGUOUS U_EA_AMBIGUOUS_4_0_
#undef U_EA_COUNT
#define U_EA_COUNT U_EA_COUNT_4_0_
#undef U_EA_FULLWIDTH
#define U_EA_FULLWIDTH U_EA_FULLWIDTH_4_0_
#undef U_EA_HALFWIDTH
#define U_EA_HALFWIDTH U_EA_HALFWIDTH_4_0_
#undef U_EA_NARROW
#define U_EA_NARROW U_EA_NARROW_4_0_
#undef U_EA_NEUTRAL
#define U_EA_NEUTRAL U_EA_NEUTRAL_4_0_
#undef U_EA_WIDE
#define U_EA_WIDE U_EA_WIDE_4_0_
#undef U_ENCLOSING_MARK
#define U_ENCLOSING_MARK U_ENCLOSING_MARK_4_0_
#undef U_END_PUNCTUATION
#define U_END_PUNCTUATION U_END_PUNCTUATION_4_0_
#undef U_ENUM_OUT_OF_SYNC_ERROR
#define U_ENUM_OUT_OF_SYNC_ERROR U_ENUM_OUT_OF_SYNC_ERROR_4_0_
#undef U_ERROR_LIMIT
#define U_ERROR_LIMIT U_ERROR_LIMIT_4_0_
#undef U_ERROR_WARNING_LIMIT
#define U_ERROR_WARNING_LIMIT U_ERROR_WARNING_LIMIT_4_0_
#undef U_ERROR_WARNING_START
#define U_ERROR_WARNING_START U_ERROR_WARNING_START_4_0_
#undef U_EUROPEAN_NUMBER
#define U_EUROPEAN_NUMBER U_EUROPEAN_NUMBER_4_0_
#undef U_EUROPEAN_NUMBER_SEPARATOR
#define U_EUROPEAN_NUMBER_SEPARATOR U_EUROPEAN_NUMBER_SEPARATOR_4_0_
#undef U_EUROPEAN_NUMBER_TERMINATOR
#define U_EUROPEAN_NUMBER_TERMINATOR U_EUROPEAN_NUMBER_TERMINATOR_4_0_
#undef U_EXTENDED_CHAR_NAME
#define U_EXTENDED_CHAR_NAME U_EXTENDED_CHAR_NAME_4_0_
#undef U_FILE_ACCESS_ERROR
#define U_FILE_ACCESS_ERROR U_FILE_ACCESS_ERROR_4_0_
#undef U_FINAL_PUNCTUATION
#define U_FINAL_PUNCTUATION U_FINAL_PUNCTUATION_4_0_
#undef U_FMT_PARSE_ERROR_LIMIT
#define U_FMT_PARSE_ERROR_LIMIT U_FMT_PARSE_ERROR_LIMIT_4_0_
#undef U_FMT_PARSE_ERROR_START
#define U_FMT_PARSE_ERROR_START U_FMT_PARSE_ERROR_START_4_0_
#undef U_FORMAT_CHAR
#define U_FORMAT_CHAR U_FORMAT_CHAR_4_0_
#undef U_GCB_CONTROL
#define U_GCB_CONTROL U_GCB_CONTROL_4_0_
#undef U_GCB_COUNT
#define U_GCB_COUNT U_GCB_COUNT_4_0_
#undef U_GCB_CR
#define U_GCB_CR U_GCB_CR_4_0_
#undef U_GCB_EXTEND
#define U_GCB_EXTEND U_GCB_EXTEND_4_0_
#undef U_GCB_L
#define U_GCB_L U_GCB_L_4_0_
#undef U_GCB_LF
#define U_GCB_LF U_GCB_LF_4_0_
#undef U_GCB_LV
#define U_GCB_LV U_GCB_LV_4_0_
#undef U_GCB_LVT
#define U_GCB_LVT U_GCB_LVT_4_0_
#undef U_GCB_OTHER
#define U_GCB_OTHER U_GCB_OTHER_4_0_
#undef U_GCB_PREPEND
#define U_GCB_PREPEND U_GCB_PREPEND_4_0_
#undef U_GCB_SPACING_MARK
#define U_GCB_SPACING_MARK U_GCB_SPACING_MARK_4_0_
#undef U_GCB_T
#define U_GCB_T U_GCB_T_4_0_
#undef U_GCB_V
#define U_GCB_V U_GCB_V_4_0_
#undef U_GENERAL_OTHER_TYPES
#define U_GENERAL_OTHER_TYPES U_GENERAL_OTHER_TYPES_4_0_
#undef U_HST_COUNT
#define U_HST_COUNT U_HST_COUNT_4_0_
#undef U_HST_LEADING_JAMO
#define U_HST_LEADING_JAMO U_HST_LEADING_JAMO_4_0_
#undef U_HST_LV_SYLLABLE
#define U_HST_LV_SYLLABLE U_HST_LV_SYLLABLE_4_0_
#undef U_HST_LVT_SYLLABLE
#define U_HST_LVT_SYLLABLE U_HST_LVT_SYLLABLE_4_0_
#undef U_HST_NOT_APPLICABLE
#define U_HST_NOT_APPLICABLE U_HST_NOT_APPLICABLE_4_0_
#undef U_HST_TRAILING_JAMO
#define U_HST_TRAILING_JAMO U_HST_TRAILING_JAMO_4_0_
#undef U_HST_VOWEL_JAMO
#define U_HST_VOWEL_JAMO U_HST_VOWEL_JAMO_4_0_
#undef U_IDNA_ACE_PREFIX_ERROR
#define U_IDNA_ACE_PREFIX_ERROR U_IDNA_ACE_PREFIX_ERROR_4_0_
#undef U_IDNA_CHECK_BIDI_ERROR
#define U_IDNA_CHECK_BIDI_ERROR U_IDNA_CHECK_BIDI_ERROR_4_0_
#undef U_IDNA_DOMAIN_NAME_TOO_LONG_ERROR
#define U_IDNA_DOMAIN_NAME_TOO_LONG_ERROR U_IDNA_DOMAIN_NAME_TOO_LONG_ERROR_4_0_
#undef U_IDNA_ERROR_LIMIT
#define U_IDNA_ERROR_LIMIT U_IDNA_ERROR_LIMIT_4_0_
#undef U_IDNA_ERROR_START
#define U_IDNA_ERROR_START U_IDNA_ERROR_START_4_0_
#undef U_IDNA_LABEL_TOO_LONG_ERROR
#define U_IDNA_LABEL_TOO_LONG_ERROR U_IDNA_LABEL_TOO_LONG_ERROR_4_0_
#undef U_IDNA_PROHIBITED_ERROR
#define U_IDNA_PROHIBITED_ERROR U_IDNA_PROHIBITED_ERROR_4_0_
#undef U_IDNA_STD3_ASCII_RULES_ERROR
#define U_IDNA_STD3_ASCII_RULES_ERROR U_IDNA_STD3_ASCII_RULES_ERROR_4_0_
#undef U_IDNA_UNASSIGNED_ERROR
#define U_IDNA_UNASSIGNED_ERROR U_IDNA_UNASSIGNED_ERROR_4_0_
#undef U_IDNA_VERIFICATION_ERROR
#define U_IDNA_VERIFICATION_ERROR U_IDNA_VERIFICATION_ERROR_4_0_
#undef U_IDNA_ZERO_LENGTH_LABEL_ERROR
#define U_IDNA_ZERO_LENGTH_LABEL_ERROR U_IDNA_ZERO_LENGTH_LABEL_ERROR_4_0_
#undef U_ILLEGAL_ARGUMENT_ERROR
#define U_ILLEGAL_ARGUMENT_ERROR U_ILLEGAL_ARGUMENT_ERROR_4_0_
#undef U_ILLEGAL_CHAR_FOUND
#define U_ILLEGAL_CHAR_FOUND U_ILLEGAL_CHAR_FOUND_4_0_
#undef U_ILLEGAL_CHAR_IN_SEGMENT
#define U_ILLEGAL_CHAR_IN_SEGMENT U_ILLEGAL_CHAR_IN_SEGMENT_4_0_
#undef U_ILLEGAL_CHARACTER
#define U_ILLEGAL_CHARACTER U_ILLEGAL_CHARACTER_4_0_
#undef U_ILLEGAL_ESCAPE_SEQUENCE
#define U_ILLEGAL_ESCAPE_SEQUENCE U_ILLEGAL_ESCAPE_SEQUENCE_4_0_
#undef U_ILLEGAL_PAD_POSITION
#define U_ILLEGAL_PAD_POSITION U_ILLEGAL_PAD_POSITION_4_0_
#undef U_INDEX_OUTOFBOUNDS_ERROR
#define U_INDEX_OUTOFBOUNDS_ERROR U_INDEX_OUTOFBOUNDS_ERROR_4_0_
#undef U_INITIAL_PUNCTUATION
#define U_INITIAL_PUNCTUATION U_INITIAL_PUNCTUATION_4_0_
#undef U_INTERNAL_PROGRAM_ERROR
#define U_INTERNAL_PROGRAM_ERROR U_INTERNAL_PROGRAM_ERROR_4_0_
#undef U_INTERNAL_TRANSLITERATOR_ERROR
#define U_INTERNAL_TRANSLITERATOR_ERROR U_INTERNAL_TRANSLITERATOR_ERROR_4_0_
#undef U_INVALID_CHAR_FOUND
#define U_INVALID_CHAR_FOUND U_INVALID_CHAR_FOUND_4_0_
#undef U_INVALID_FORMAT_ERROR
#define U_INVALID_FORMAT_ERROR U_INVALID_FORMAT_ERROR_4_0_
#undef U_INVALID_FUNCTION
#define U_INVALID_FUNCTION U_INVALID_FUNCTION_4_0_
#undef U_INVALID_ID
#define U_INVALID_ID U_INVALID_ID_4_0_
#undef U_INVALID_PROPERTY_PATTERN
#define U_INVALID_PROPERTY_PATTERN U_INVALID_PROPERTY_PATTERN_4_0_
#undef U_INVALID_RBT_SYNTAX
#define U_INVALID_RBT_SYNTAX U_INVALID_RBT_SYNTAX_4_0_
#undef U_INVALID_STATE_ERROR
#define U_INVALID_STATE_ERROR U_INVALID_STATE_ERROR_4_0_
#undef U_INVALID_TABLE_FILE
#define U_INVALID_TABLE_FILE U_INVALID_TABLE_FILE_4_0_
#undef U_INVALID_TABLE_FORMAT
#define U_INVALID_TABLE_FORMAT U_INVALID_TABLE_FORMAT_4_0_
#undef U_INVARIANT_CONVERSION_ERROR
#define U_INVARIANT_CONVERSION_ERROR U_INVARIANT_CONVERSION_ERROR_4_0_
#undef U_JG_AIN
#define U_JG_AIN U_JG_AIN_4_0_
#undef U_JG_ALAPH
#define U_JG_ALAPH U_JG_ALAPH_4_0_
#undef U_JG_ALEF
#define U_JG_ALEF U_JG_ALEF_4_0_
#undef U_JG_BEH
#define U_JG_BEH U_JG_BEH_4_0_
#undef U_JG_BETH
#define U_JG_BETH U_JG_BETH_4_0_
#undef U_JG_BURUSHASKI_YEH_BARREE
#define U_JG_BURUSHASKI_YEH_BARREE U_JG_BURUSHASKI_YEH_BARREE_4_0_
#undef U_JG_COUNT
#define U_JG_COUNT U_JG_COUNT_4_0_
#undef U_JG_DAL
#define U_JG_DAL U_JG_DAL_4_0_
#undef U_JG_DALATH_RISH
#define U_JG_DALATH_RISH U_JG_DALATH_RISH_4_0_
#undef U_JG_E
#define U_JG_E U_JG_E_4_0_
#undef U_JG_FE
#define U_JG_FE U_JG_FE_4_0_
#undef U_JG_FEH
#define U_JG_FEH U_JG_FEH_4_0_
#undef U_JG_FINAL_SEMKATH
#define U_JG_FINAL_SEMKATH U_JG_FINAL_SEMKATH_4_0_
#undef U_JG_GAF
#define U_JG_GAF U_JG_GAF_4_0_
#undef U_JG_GAMAL
#define U_JG_GAMAL U_JG_GAMAL_4_0_
#undef U_JG_HAH
#define U_JG_HAH U_JG_HAH_4_0_
#undef U_JG_HAMZA_ON_HEH_GOAL
#define U_JG_HAMZA_ON_HEH_GOAL U_JG_HAMZA_ON_HEH_GOAL_4_0_
#undef U_JG_HE
#define U_JG_HE U_JG_HE_4_0_
#undef U_JG_HEH
#define U_JG_HEH U_JG_HEH_4_0_
#undef U_JG_HEH_GOAL
#define U_JG_HEH_GOAL U_JG_HEH_GOAL_4_0_
#undef U_JG_HETH
#define U_JG_HETH U_JG_HETH_4_0_
#undef U_JG_KAF
#define U_JG_KAF U_JG_KAF_4_0_
#undef U_JG_KAPH
#define U_JG_KAPH U_JG_KAPH_4_0_
#undef U_JG_KHAPH
#define U_JG_KHAPH U_JG_KHAPH_4_0_
#undef U_JG_KNOTTED_HEH
#define U_JG_KNOTTED_HEH U_JG_KNOTTED_HEH_4_0_
#undef U_JG_LAM
#define U_JG_LAM U_JG_LAM_4_0_
#undef U_JG_LAMADH
#define U_JG_LAMADH U_JG_LAMADH_4_0_
#undef U_JG_MEEM
#define U_JG_MEEM U_JG_MEEM_4_0_
#undef U_JG_MIM
#define U_JG_MIM U_JG_MIM_4_0_
#undef U_JG_NO_JOINING_GROUP
#define U_JG_NO_JOINING_GROUP U_JG_NO_JOINING_GROUP_4_0_
#undef U_JG_NOON
#define U_JG_NOON U_JG_NOON_4_0_
#undef U_JG_NUN
#define U_JG_NUN U_JG_NUN_4_0_
#undef U_JG_PE
#define U_JG_PE U_JG_PE_4_0_
#undef U_JG_QAF
#define U_JG_QAF U_JG_QAF_4_0_
#undef U_JG_QAPH
#define U_JG_QAPH U_JG_QAPH_4_0_
#undef U_JG_REH
#define U_JG_REH U_JG_REH_4_0_
#undef U_JG_REVERSED_PE
#define U_JG_REVERSED_PE U_JG_REVERSED_PE_4_0_
#undef U_JG_SAD
#define U_JG_SAD U_JG_SAD_4_0_
#undef U_JG_SADHE
#define U_JG_SADHE U_JG_SADHE_4_0_
#undef U_JG_SEEN
#define U_JG_SEEN U_JG_SEEN_4_0_
#undef U_JG_SEMKATH
#define U_JG_SEMKATH U_JG_SEMKATH_4_0_
#undef U_JG_SHIN
#define U_JG_SHIN U_JG_SHIN_4_0_
#undef U_JG_SWASH_KAF
#define U_JG_SWASH_KAF U_JG_SWASH_KAF_4_0_
#undef U_JG_SYRIAC_WAW
#define U_JG_SYRIAC_WAW U_JG_SYRIAC_WAW_4_0_
#undef U_JG_TAH
#define U_JG_TAH U_JG_TAH_4_0_
#undef U_JG_TAW
#define U_JG_TAW U_JG_TAW_4_0_
#undef U_JG_TEH_MARBUTA
#define U_JG_TEH_MARBUTA U_JG_TEH_MARBUTA_4_0_
#undef U_JG_TETH
#define U_JG_TETH U_JG_TETH_4_0_
#undef U_JG_WAW
#define U_JG_WAW U_JG_WAW_4_0_
#undef U_JG_YEH
#define U_JG_YEH U_JG_YEH_4_0_
#undef U_JG_YEH_BARREE
#define U_JG_YEH_BARREE U_JG_YEH_BARREE_4_0_
#undef U_JG_YEH_WITH_TAIL
#define U_JG_YEH_WITH_TAIL U_JG_YEH_WITH_TAIL_4_0_
#undef U_JG_YUDH
#define U_JG_YUDH U_JG_YUDH_4_0_
#undef U_JG_YUDH_HE
#define U_JG_YUDH_HE U_JG_YUDH_HE_4_0_
#undef U_JG_ZAIN
#define U_JG_ZAIN U_JG_ZAIN_4_0_
#undef U_JG_ZHAIN
#define U_JG_ZHAIN U_JG_ZHAIN_4_0_
#undef U_JT_COUNT
#define U_JT_COUNT U_JT_COUNT_4_0_
#undef U_JT_DUAL_JOINING
#define U_JT_DUAL_JOINING U_JT_DUAL_JOINING_4_0_
#undef U_JT_JOIN_CAUSING
#define U_JT_JOIN_CAUSING U_JT_JOIN_CAUSING_4_0_
#undef U_JT_LEFT_JOINING
#define U_JT_LEFT_JOINING U_JT_LEFT_JOINING_4_0_
#undef U_JT_NON_JOINING
#define U_JT_NON_JOINING U_JT_NON_JOINING_4_0_
#undef U_JT_RIGHT_JOINING
#define U_JT_RIGHT_JOINING U_JT_RIGHT_JOINING_4_0_
#undef U_JT_TRANSPARENT
#define U_JT_TRANSPARENT U_JT_TRANSPARENT_4_0_
#undef U_LB_ALPHABETIC
#define U_LB_ALPHABETIC U_LB_ALPHABETIC_4_0_
#undef U_LB_AMBIGUOUS
#define U_LB_AMBIGUOUS U_LB_AMBIGUOUS_4_0_
#undef U_LB_BREAK_AFTER
#define U_LB_BREAK_AFTER U_LB_BREAK_AFTER_4_0_
#undef U_LB_BREAK_BEFORE
#define U_LB_BREAK_BEFORE U_LB_BREAK_BEFORE_4_0_
#undef U_LB_BREAK_BOTH
#define U_LB_BREAK_BOTH U_LB_BREAK_BOTH_4_0_
#undef U_LB_BREAK_SYMBOLS
#define U_LB_BREAK_SYMBOLS U_LB_BREAK_SYMBOLS_4_0_
#undef U_LB_CARRIAGE_RETURN
#define U_LB_CARRIAGE_RETURN U_LB_CARRIAGE_RETURN_4_0_
#undef U_LB_CLOSE_PUNCTUATION
#define U_LB_CLOSE_PUNCTUATION U_LB_CLOSE_PUNCTUATION_4_0_
#undef U_LB_COMBINING_MARK
#define U_LB_COMBINING_MARK U_LB_COMBINING_MARK_4_0_
#undef U_LB_COMPLEX_CONTEXT
#define U_LB_COMPLEX_CONTEXT U_LB_COMPLEX_CONTEXT_4_0_
#undef U_LB_CONTINGENT_BREAK
#define U_LB_CONTINGENT_BREAK U_LB_CONTINGENT_BREAK_4_0_
#undef U_LB_COUNT
#define U_LB_COUNT U_LB_COUNT_4_0_
#undef U_LB_EXCLAMATION
#define U_LB_EXCLAMATION U_LB_EXCLAMATION_4_0_
#undef U_LB_GLUE
#define U_LB_GLUE U_LB_GLUE_4_0_
#undef U_LB_H2
#define U_LB_H2 U_LB_H2_4_0_
#undef U_LB_H3
#define U_LB_H3 U_LB_H3_4_0_
#undef U_LB_HYPHEN
#define U_LB_HYPHEN U_LB_HYPHEN_4_0_
#undef U_LB_IDEOGRAPHIC
#define U_LB_IDEOGRAPHIC U_LB_IDEOGRAPHIC_4_0_
#undef U_LB_INFIX_NUMERIC
#define U_LB_INFIX_NUMERIC U_LB_INFIX_NUMERIC_4_0_
#undef U_LB_INSEPARABLE
#define U_LB_INSEPARABLE U_LB_INSEPARABLE_4_0_
#undef U_LB_INSEPERABLE
#define U_LB_INSEPERABLE U_LB_INSEPERABLE_4_0_
#undef U_LB_JL
#define U_LB_JL U_LB_JL_4_0_
#undef U_LB_JT
#define U_LB_JT U_LB_JT_4_0_
#undef U_LB_JV
#define U_LB_JV U_LB_JV_4_0_
#undef U_LB_LINE_FEED
#define U_LB_LINE_FEED U_LB_LINE_FEED_4_0_
#undef U_LB_MANDATORY_BREAK
#define U_LB_MANDATORY_BREAK U_LB_MANDATORY_BREAK_4_0_
#undef U_LB_NEXT_LINE
#define U_LB_NEXT_LINE U_LB_NEXT_LINE_4_0_
#undef U_LB_NONSTARTER
#define U_LB_NONSTARTER U_LB_NONSTARTER_4_0_
#undef U_LB_NUMERIC
#define U_LB_NUMERIC U_LB_NUMERIC_4_0_
#undef U_LB_OPEN_PUNCTUATION
#define U_LB_OPEN_PUNCTUATION U_LB_OPEN_PUNCTUATION_4_0_
#undef U_LB_POSTFIX_NUMERIC
#define U_LB_POSTFIX_NUMERIC U_LB_POSTFIX_NUMERIC_4_0_
#undef U_LB_PREFIX_NUMERIC
#define U_LB_PREFIX_NUMERIC U_LB_PREFIX_NUMERIC_4_0_
#undef U_LB_QUOTATION
#define U_LB_QUOTATION U_LB_QUOTATION_4_0_
#undef U_LB_SPACE
#define U_LB_SPACE U_LB_SPACE_4_0_
#undef U_LB_SURROGATE
#define U_LB_SURROGATE U_LB_SURROGATE_4_0_
#undef U_LB_UNKNOWN
#define U_LB_UNKNOWN U_LB_UNKNOWN_4_0_
#undef U_LB_WORD_JOINER
#define U_LB_WORD_JOINER U_LB_WORD_JOINER_4_0_
#undef U_LB_ZWSPACE
#define U_LB_ZWSPACE U_LB_ZWSPACE_4_0_
#undef U_LEFT_TO_RIGHT
#define U_LEFT_TO_RIGHT U_LEFT_TO_RIGHT_4_0_
#undef U_LEFT_TO_RIGHT_EMBEDDING
#define U_LEFT_TO_RIGHT_EMBEDDING U_LEFT_TO_RIGHT_EMBEDDING_4_0_
#undef U_LEFT_TO_RIGHT_OVERRIDE
#define U_LEFT_TO_RIGHT_OVERRIDE U_LEFT_TO_RIGHT_OVERRIDE_4_0_
#undef U_LETTER_NUMBER
#define U_LETTER_NUMBER U_LETTER_NUMBER_4_0_
#undef U_LINE_SEPARATOR
#define U_LINE_SEPARATOR U_LINE_SEPARATOR_4_0_
#undef U_LONG_PROPERTY_NAME
#define U_LONG_PROPERTY_NAME U_LONG_PROPERTY_NAME_4_0_
#undef U_LOWERCASE_LETTER
#define U_LOWERCASE_LETTER U_LOWERCASE_LETTER_4_0_
#undef U_MALFORMED_EXPONENTIAL_PATTERN
#define U_MALFORMED_EXPONENTIAL_PATTERN U_MALFORMED_EXPONENTIAL_PATTERN_4_0_
#undef U_MALFORMED_PRAGMA
#define U_MALFORMED_PRAGMA U_MALFORMED_PRAGMA_4_0_
#undef U_MALFORMED_RULE
#define U_MALFORMED_RULE U_MALFORMED_RULE_4_0_
#undef U_MALFORMED_SET
#define U_MALFORMED_SET U_MALFORMED_SET_4_0_
#undef U_MALFORMED_SYMBOL_REFERENCE
#define U_MALFORMED_SYMBOL_REFERENCE U_MALFORMED_SYMBOL_REFERENCE_4_0_
#undef U_MALFORMED_UNICODE_ESCAPE
#define U_MALFORMED_UNICODE_ESCAPE U_MALFORMED_UNICODE_ESCAPE_4_0_
#undef U_MALFORMED_VARIABLE_DEFINITION
#define U_MALFORMED_VARIABLE_DEFINITION U_MALFORMED_VARIABLE_DEFINITION_4_0_
#undef U_MALFORMED_VARIABLE_REFERENCE
#define U_MALFORMED_VARIABLE_REFERENCE U_MALFORMED_VARIABLE_REFERENCE_4_0_
#undef U_MATH_SYMBOL
#define U_MATH_SYMBOL U_MATH_SYMBOL_4_0_
#undef U_MEMORY_ALLOCATION_ERROR
#define U_MEMORY_ALLOCATION_ERROR U_MEMORY_ALLOCATION_ERROR_4_0_
#undef U_MESSAGE_PARSE_ERROR
#define U_MESSAGE_PARSE_ERROR U_MESSAGE_PARSE_ERROR_4_0_
#undef U_MISMATCHED_SEGMENT_DELIMITERS
#define U_MISMATCHED_SEGMENT_DELIMITERS U_MISMATCHED_SEGMENT_DELIMITERS_4_0_
#undef U_MISPLACED_ANCHOR_START
#define U_MISPLACED_ANCHOR_START U_MISPLACED_ANCHOR_START_4_0_
#undef U_MISPLACED_COMPOUND_FILTER
#define U_MISPLACED_COMPOUND_FILTER U_MISPLACED_COMPOUND_FILTER_4_0_
#undef U_MISPLACED_CURSOR_OFFSET
#define U_MISPLACED_CURSOR_OFFSET U_MISPLACED_CURSOR_OFFSET_4_0_
#undef U_MISPLACED_QUANTIFIER
#define U_MISPLACED_QUANTIFIER U_MISPLACED_QUANTIFIER_4_0_
#undef U_MISSING_OPERATOR
#define U_MISSING_OPERATOR U_MISSING_OPERATOR_4_0_
#undef U_MISSING_RESOURCE_ERROR
#define U_MISSING_RESOURCE_ERROR U_MISSING_RESOURCE_ERROR_4_0_
#undef U_MISSING_SEGMENT_CLOSE
#define U_MISSING_SEGMENT_CLOSE U_MISSING_SEGMENT_CLOSE_4_0_
#undef U_MODIFIER_LETTER
#define U_MODIFIER_LETTER U_MODIFIER_LETTER_4_0_
#undef U_MODIFIER_SYMBOL
#define U_MODIFIER_SYMBOL U_MODIFIER_SYMBOL_4_0_
#undef U_MULTIPLE_ANTE_CONTEXTS
#define U_MULTIPLE_ANTE_CONTEXTS U_MULTIPLE_ANTE_CONTEXTS_4_0_
#undef U_MULTIPLE_COMPOUND_FILTERS
#define U_MULTIPLE_COMPOUND_FILTERS U_MULTIPLE_COMPOUND_FILTERS_4_0_
#undef U_MULTIPLE_CURSORS
#define U_MULTIPLE_CURSORS U_MULTIPLE_CURSORS_4_0_
#undef U_MULTIPLE_DECIMAL_SEPARATORS
#define U_MULTIPLE_DECIMAL_SEPARATORS U_MULTIPLE_DECIMAL_SEPARATORS_4_0_
#undef U_MULTIPLE_DECIMAL_SEPERATORS
#define U_MULTIPLE_DECIMAL_SEPERATORS U_MULTIPLE_DECIMAL_SEPERATORS_4_0_
#undef U_MULTIPLE_EXPONENTIAL_SYMBOLS
#define U_MULTIPLE_EXPONENTIAL_SYMBOLS U_MULTIPLE_EXPONENTIAL_SYMBOLS_4_0_
#undef U_MULTIPLE_PAD_SPECIFIERS
#define U_MULTIPLE_PAD_SPECIFIERS U_MULTIPLE_PAD_SPECIFIERS_4_0_
#undef U_MULTIPLE_PERCENT_SYMBOLS
#define U_MULTIPLE_PERCENT_SYMBOLS U_MULTIPLE_PERCENT_SYMBOLS_4_0_
#undef U_MULTIPLE_PERMILL_SYMBOLS
#define U_MULTIPLE_PERMILL_SYMBOLS U_MULTIPLE_PERMILL_SYMBOLS_4_0_
#undef U_MULTIPLE_POST_CONTEXTS
#define U_MULTIPLE_POST_CONTEXTS U_MULTIPLE_POST_CONTEXTS_4_0_
#undef U_NO_SPACE_AVAILABLE
#define U_NO_SPACE_AVAILABLE U_NO_SPACE_AVAILABLE_4_0_
#undef U_NO_WRITE_PERMISSION
#define U_NO_WRITE_PERMISSION U_NO_WRITE_PERMISSION_4_0_
#undef U_NON_SPACING_MARK
#define U_NON_SPACING_MARK U_NON_SPACING_MARK_4_0_
#undef U_NT_COUNT
#define U_NT_COUNT U_NT_COUNT_4_0_
#undef U_NT_DECIMAL
#define U_NT_DECIMAL U_NT_DECIMAL_4_0_
#undef U_NT_DIGIT
#define U_NT_DIGIT U_NT_DIGIT_4_0_
#undef U_NT_NONE
#define U_NT_NONE U_NT_NONE_4_0_
#undef U_NT_NUMERIC
#define U_NT_NUMERIC U_NT_NUMERIC_4_0_
#undef U_OTHER_LETTER
#define U_OTHER_LETTER U_OTHER_LETTER_4_0_
#undef U_OTHER_NEUTRAL
#define U_OTHER_NEUTRAL U_OTHER_NEUTRAL_4_0_
#undef U_OTHER_NUMBER
#define U_OTHER_NUMBER U_OTHER_NUMBER_4_0_
#undef U_OTHER_PUNCTUATION
#define U_OTHER_PUNCTUATION U_OTHER_PUNCTUATION_4_0_
#undef U_OTHER_SYMBOL
#define U_OTHER_SYMBOL U_OTHER_SYMBOL_4_0_
#undef U_PARAGRAPH_SEPARATOR
#define U_PARAGRAPH_SEPARATOR U_PARAGRAPH_SEPARATOR_4_0_
#undef U_PARSE_CONTEXT_LEN
#define U_PARSE_CONTEXT_LEN U_PARSE_CONTEXT_LEN_4_0_
#undef U_PARSE_ERROR
#define U_PARSE_ERROR U_PARSE_ERROR_4_0_
#undef U_PARSE_ERROR_LIMIT
#define U_PARSE_ERROR_LIMIT U_PARSE_ERROR_LIMIT_4_0_
#undef U_PARSE_ERROR_START
#define U_PARSE_ERROR_START U_PARSE_ERROR_START_4_0_
#undef U_PATTERN_SYNTAX_ERROR
#define U_PATTERN_SYNTAX_ERROR U_PATTERN_SYNTAX_ERROR_4_0_
#undef U_POP_DIRECTIONAL_FORMAT
#define U_POP_DIRECTIONAL_FORMAT U_POP_DIRECTIONAL_FORMAT_4_0_
#undef U_PRIMARY_TOO_LONG_ERROR
#define U_PRIMARY_TOO_LONG_ERROR U_PRIMARY_TOO_LONG_ERROR_4_0_
#undef U_PRIVATE_USE_CHAR
#define U_PRIVATE_USE_CHAR U_PRIVATE_USE_CHAR_4_0_
#undef U_PROPERTY_NAME_CHOICE_COUNT
#define U_PROPERTY_NAME_CHOICE_COUNT U_PROPERTY_NAME_CHOICE_COUNT_4_0_
#undef U_REGEX_BAD_ESCAPE_SEQUENCE
#define U_REGEX_BAD_ESCAPE_SEQUENCE U_REGEX_BAD_ESCAPE_SEQUENCE_4_0_
#undef U_REGEX_BAD_INTERVAL
#define U_REGEX_BAD_INTERVAL U_REGEX_BAD_INTERVAL_4_0_
#undef U_REGEX_ERROR_LIMIT
#define U_REGEX_ERROR_LIMIT U_REGEX_ERROR_LIMIT_4_0_
#undef U_REGEX_ERROR_START
#define U_REGEX_ERROR_START U_REGEX_ERROR_START_4_0_
#undef U_REGEX_INTERNAL_ERROR
#define U_REGEX_INTERNAL_ERROR U_REGEX_INTERNAL_ERROR_4_0_
#undef U_REGEX_INVALID_BACK_REF
#define U_REGEX_INVALID_BACK_REF U_REGEX_INVALID_BACK_REF_4_0_
#undef U_REGEX_INVALID_FLAG
#define U_REGEX_INVALID_FLAG U_REGEX_INVALID_FLAG_4_0_
#undef U_REGEX_INVALID_RANGE
#define U_REGEX_INVALID_RANGE U_REGEX_INVALID_RANGE_4_0_
#undef U_REGEX_INVALID_STATE
#define U_REGEX_INVALID_STATE U_REGEX_INVALID_STATE_4_0_
#undef U_REGEX_LOOK_BEHIND_LIMIT
#define U_REGEX_LOOK_BEHIND_LIMIT U_REGEX_LOOK_BEHIND_LIMIT_4_0_
#undef U_REGEX_MAX_LT_MIN
#define U_REGEX_MAX_LT_MIN U_REGEX_MAX_LT_MIN_4_0_
#undef U_REGEX_MISMATCHED_PAREN
#define U_REGEX_MISMATCHED_PAREN U_REGEX_MISMATCHED_PAREN_4_0_
#undef U_REGEX_MISSING_CLOSE_BRACKET
#define U_REGEX_MISSING_CLOSE_BRACKET U_REGEX_MISSING_CLOSE_BRACKET_4_0_
#undef U_REGEX_NUMBER_TOO_BIG
#define U_REGEX_NUMBER_TOO_BIG U_REGEX_NUMBER_TOO_BIG_4_0_
#undef U_REGEX_OCTAL_TOO_BIG
#define U_REGEX_OCTAL_TOO_BIG U_REGEX_OCTAL_TOO_BIG_4_0_
#undef U_REGEX_PROPERTY_SYNTAX
#define U_REGEX_PROPERTY_SYNTAX U_REGEX_PROPERTY_SYNTAX_4_0_
#undef U_REGEX_RULE_SYNTAX
#define U_REGEX_RULE_SYNTAX U_REGEX_RULE_SYNTAX_4_0_
#undef U_REGEX_SET_CONTAINS_STRING
#define U_REGEX_SET_CONTAINS_STRING U_REGEX_SET_CONTAINS_STRING_4_0_
#undef U_REGEX_STACK_OVERFLOW
#define U_REGEX_STACK_OVERFLOW U_REGEX_STACK_OVERFLOW_4_0_
#undef U_REGEX_STOPPED_BY_CALLER
#define U_REGEX_STOPPED_BY_CALLER U_REGEX_STOPPED_BY_CALLER_4_0_
#undef U_REGEX_TIME_OUT
#define U_REGEX_TIME_OUT U_REGEX_TIME_OUT_4_0_
#undef U_REGEX_UNIMPLEMENTED
#define U_REGEX_UNIMPLEMENTED U_REGEX_UNIMPLEMENTED_4_0_
#undef U_RESOURCE_TYPE_MISMATCH
#define U_RESOURCE_TYPE_MISMATCH U_RESOURCE_TYPE_MISMATCH_4_0_
#undef U_RIGHT_TO_LEFT
#define U_RIGHT_TO_LEFT U_RIGHT_TO_LEFT_4_0_
#undef U_RIGHT_TO_LEFT_ARABIC
#define U_RIGHT_TO_LEFT_ARABIC U_RIGHT_TO_LEFT_ARABIC_4_0_
#undef U_RIGHT_TO_LEFT_EMBEDDING
#define U_RIGHT_TO_LEFT_EMBEDDING U_RIGHT_TO_LEFT_EMBEDDING_4_0_
#undef U_RIGHT_TO_LEFT_OVERRIDE
#define U_RIGHT_TO_LEFT_OVERRIDE U_RIGHT_TO_LEFT_OVERRIDE_4_0_
#undef U_RULE_MASK_ERROR
#define U_RULE_MASK_ERROR U_RULE_MASK_ERROR_4_0_
#undef U_SAFECLONE_ALLOCATED_WARNING
#define U_SAFECLONE_ALLOCATED_WARNING U_SAFECLONE_ALLOCATED_WARNING_4_0_
#undef U_SB_ATERM
#define U_SB_ATERM U_SB_ATERM_4_0_
#undef U_SB_CLOSE
#define U_SB_CLOSE U_SB_CLOSE_4_0_
#undef U_SB_COUNT
#define U_SB_COUNT U_SB_COUNT_4_0_
#undef U_SB_CR
#define U_SB_CR U_SB_CR_4_0_
#undef U_SB_EXTEND
#define U_SB_EXTEND U_SB_EXTEND_4_0_
#undef U_SB_FORMAT
#define U_SB_FORMAT U_SB_FORMAT_4_0_
#undef U_SB_LF
#define U_SB_LF U_SB_LF_4_0_
#undef U_SB_LOWER
#define U_SB_LOWER U_SB_LOWER_4_0_
#undef U_SB_NUMERIC
#define U_SB_NUMERIC U_SB_NUMERIC_4_0_
#undef U_SB_OLETTER
#define U_SB_OLETTER U_SB_OLETTER_4_0_
#undef U_SB_OTHER
#define U_SB_OTHER U_SB_OTHER_4_0_
#undef U_SB_SCONTINUE
#define U_SB_SCONTINUE U_SB_SCONTINUE_4_0_
#undef U_SB_SEP
#define U_SB_SEP U_SB_SEP_4_0_
#undef U_SB_SP
#define U_SB_SP U_SB_SP_4_0_
#undef U_SB_STERM
#define U_SB_STERM U_SB_STERM_4_0_
#undef U_SB_UPPER
#define U_SB_UPPER U_SB_UPPER_4_0_
#undef U_SEGMENT_SEPARATOR
#define U_SEGMENT_SEPARATOR U_SEGMENT_SEPARATOR_4_0_
#undef U_SHORT_PROPERTY_NAME
#define U_SHORT_PROPERTY_NAME U_SHORT_PROPERTY_NAME_4_0_
#undef U_SORT_KEY_TOO_SHORT_WARNING
#define U_SORT_KEY_TOO_SHORT_WARNING U_SORT_KEY_TOO_SHORT_WARNING_4_0_
#undef U_SPACE_SEPARATOR
#define U_SPACE_SEPARATOR U_SPACE_SEPARATOR_4_0_
#undef U_STANDARD_ERROR_LIMIT
#define U_STANDARD_ERROR_LIMIT U_STANDARD_ERROR_LIMIT_4_0_
#undef U_START_PUNCTUATION
#define U_START_PUNCTUATION U_START_PUNCTUATION_4_0_
#undef U_STATE_OLD_WARNING
#define U_STATE_OLD_WARNING U_STATE_OLD_WARNING_4_0_
#undef U_STATE_TOO_OLD_ERROR
#define U_STATE_TOO_OLD_ERROR U_STATE_TOO_OLD_ERROR_4_0_
#undef U_STRING_NOT_TERMINATED_WARNING
#define U_STRING_NOT_TERMINATED_WARNING U_STRING_NOT_TERMINATED_WARNING_4_0_
#undef U_STRINGPREP_CHECK_BIDI_ERROR
#define U_STRINGPREP_CHECK_BIDI_ERROR U_STRINGPREP_CHECK_BIDI_ERROR_4_0_
#undef U_STRINGPREP_PROHIBITED_ERROR
#define U_STRINGPREP_PROHIBITED_ERROR U_STRINGPREP_PROHIBITED_ERROR_4_0_
#undef U_STRINGPREP_UNASSIGNED_ERROR
#define U_STRINGPREP_UNASSIGNED_ERROR U_STRINGPREP_UNASSIGNED_ERROR_4_0_
#undef U_SURROGATE
#define U_SURROGATE U_SURROGATE_4_0_
#undef U_TITLECASE_LETTER
#define U_TITLECASE_LETTER U_TITLECASE_LETTER_4_0_
#undef U_TOO_MANY_ALIASES_ERROR
#define U_TOO_MANY_ALIASES_ERROR U_TOO_MANY_ALIASES_ERROR_4_0_
#undef U_TRAILING_BACKSLASH
#define U_TRAILING_BACKSLASH U_TRAILING_BACKSLASH_4_0_
#undef U_TRUNCATED_CHAR_FOUND
#define U_TRUNCATED_CHAR_FOUND U_TRUNCATED_CHAR_FOUND_4_0_
#undef U_UNASSIGNED
#define U_UNASSIGNED U_UNASSIGNED_4_0_
#undef U_UNCLOSED_SEGMENT
#define U_UNCLOSED_SEGMENT U_UNCLOSED_SEGMENT_4_0_
#undef U_UNDEFINED_KEYWORD
#define U_UNDEFINED_KEYWORD U_UNDEFINED_KEYWORD_4_0_
#undef U_UNDEFINED_SEGMENT_REFERENCE
#define U_UNDEFINED_SEGMENT_REFERENCE U_UNDEFINED_SEGMENT_REFERENCE_4_0_
#undef U_UNDEFINED_VARIABLE
#define U_UNDEFINED_VARIABLE U_UNDEFINED_VARIABLE_4_0_
#undef U_UNEXPECTED_TOKEN
#define U_UNEXPECTED_TOKEN U_UNEXPECTED_TOKEN_4_0_
#undef U_UNICODE_10_CHAR_NAME
#define U_UNICODE_10_CHAR_NAME U_UNICODE_10_CHAR_NAME_4_0_
#undef U_UNICODE_CHAR_NAME
#define U_UNICODE_CHAR_NAME U_UNICODE_CHAR_NAME_4_0_
#undef U_UNMATCHED_BRACES
#define U_UNMATCHED_BRACES U_UNMATCHED_BRACES_4_0_
#undef U_UNQUOTED_SPECIAL
#define U_UNQUOTED_SPECIAL U_UNQUOTED_SPECIAL_4_0_
#undef U_UNSUPPORTED_ATTRIBUTE
#define U_UNSUPPORTED_ATTRIBUTE U_UNSUPPORTED_ATTRIBUTE_4_0_
#undef U_UNSUPPORTED_ERROR
#define U_UNSUPPORTED_ERROR U_UNSUPPORTED_ERROR_4_0_
#undef U_UNSUPPORTED_ESCAPE_SEQUENCE
#define U_UNSUPPORTED_ESCAPE_SEQUENCE U_UNSUPPORTED_ESCAPE_SEQUENCE_4_0_
#undef U_UNSUPPORTED_PROPERTY
#define U_UNSUPPORTED_PROPERTY U_UNSUPPORTED_PROPERTY_4_0_
#undef U_UNTERMINATED_QUOTE
#define U_UNTERMINATED_QUOTE U_UNTERMINATED_QUOTE_4_0_
#undef U_UPPERCASE_LETTER
#define U_UPPERCASE_LETTER U_UPPERCASE_LETTER_4_0_
#undef U_USELESS_COLLATOR_ERROR
#define U_USELESS_COLLATOR_ERROR U_USELESS_COLLATOR_ERROR_4_0_
#undef U_USING_DEFAULT_WARNING
#define U_USING_DEFAULT_WARNING U_USING_DEFAULT_WARNING_4_0_
#undef U_USING_FALLBACK_WARNING
#define U_USING_FALLBACK_WARNING U_USING_FALLBACK_WARNING_4_0_
#undef U_VARIABLE_RANGE_EXHAUSTED
#define U_VARIABLE_RANGE_EXHAUSTED U_VARIABLE_RANGE_EXHAUSTED_4_0_
#undef U_VARIABLE_RANGE_OVERLAP
#define U_VARIABLE_RANGE_OVERLAP U_VARIABLE_RANGE_OVERLAP_4_0_
#undef U_WB_ALETTER
#define U_WB_ALETTER U_WB_ALETTER_4_0_
#undef U_WB_COUNT
#define U_WB_COUNT U_WB_COUNT_4_0_
#undef U_WB_CR
#define U_WB_CR U_WB_CR_4_0_
#undef U_WB_EXTEND
#define U_WB_EXTEND U_WB_EXTEND_4_0_
#undef U_WB_EXTENDNUMLET
#define U_WB_EXTENDNUMLET U_WB_EXTENDNUMLET_4_0_
#undef U_WB_FORMAT
#define U_WB_FORMAT U_WB_FORMAT_4_0_
#undef U_WB_KATAKANA
#define U_WB_KATAKANA U_WB_KATAKANA_4_0_
#undef U_WB_LF
#define U_WB_LF U_WB_LF_4_0_
#undef U_WB_MIDLETTER
#define U_WB_MIDLETTER U_WB_MIDLETTER_4_0_
#undef U_WB_MIDNUM
#define U_WB_MIDNUM U_WB_MIDNUM_4_0_
#undef U_WB_MIDNUMLET
#define U_WB_MIDNUMLET U_WB_MIDNUMLET_4_0_
#undef U_WB_NEWLINE
#define U_WB_NEWLINE U_WB_NEWLINE_4_0_
#undef U_WB_NUMERIC
#define U_WB_NUMERIC U_WB_NUMERIC_4_0_
#undef U_WB_OTHER
#define U_WB_OTHER U_WB_OTHER_4_0_
#undef U_WHITE_SPACE_NEUTRAL
#define U_WHITE_SPACE_NEUTRAL U_WHITE_SPACE_NEUTRAL_4_0_
#undef U_ZERO_ERROR
#define U_ZERO_ERROR U_ZERO_ERROR_4_0_
#undef UAcceptResult
#define UAcceptResult UAcceptResult_4_0_
#undef UBLOCK_AEGEAN_NUMBERS
#define UBLOCK_AEGEAN_NUMBERS UBLOCK_AEGEAN_NUMBERS_4_0_
#undef UBLOCK_ALPHABETIC_PRESENTATION_FORMS
#define UBLOCK_ALPHABETIC_PRESENTATION_FORMS UBLOCK_ALPHABETIC_PRESENTATION_FORMS_4_0_
#undef UBLOCK_ANCIENT_GREEK_MUSICAL_NOTATION
#define UBLOCK_ANCIENT_GREEK_MUSICAL_NOTATION UBLOCK_ANCIENT_GREEK_MUSICAL_NOTATION_4_0_
#undef UBLOCK_ANCIENT_GREEK_NUMBERS
#define UBLOCK_ANCIENT_GREEK_NUMBERS UBLOCK_ANCIENT_GREEK_NUMBERS_4_0_
#undef UBLOCK_ANCIENT_SYMBOLS
#define UBLOCK_ANCIENT_SYMBOLS UBLOCK_ANCIENT_SYMBOLS_4_0_
#undef UBLOCK_ARABIC
#define UBLOCK_ARABIC UBLOCK_ARABIC_4_0_
#undef UBLOCK_ARABIC_PRESENTATION_FORMS_A
#define UBLOCK_ARABIC_PRESENTATION_FORMS_A UBLOCK_ARABIC_PRESENTATION_FORMS_A_4_0_
#undef UBLOCK_ARABIC_PRESENTATION_FORMS_B
#define UBLOCK_ARABIC_PRESENTATION_FORMS_B UBLOCK_ARABIC_PRESENTATION_FORMS_B_4_0_
#undef UBLOCK_ARABIC_SUPPLEMENT
#define UBLOCK_ARABIC_SUPPLEMENT UBLOCK_ARABIC_SUPPLEMENT_4_0_
#undef UBLOCK_ARMENIAN
#define UBLOCK_ARMENIAN UBLOCK_ARMENIAN_4_0_
#undef UBLOCK_ARROWS
#define UBLOCK_ARROWS UBLOCK_ARROWS_4_0_
#undef UBLOCK_BALINESE
#define UBLOCK_BALINESE UBLOCK_BALINESE_4_0_
#undef UBLOCK_BASIC_LATIN
#define UBLOCK_BASIC_LATIN UBLOCK_BASIC_LATIN_4_0_
#undef UBLOCK_BENGALI
#define UBLOCK_BENGALI UBLOCK_BENGALI_4_0_
#undef UBLOCK_BLOCK_ELEMENTS
#define UBLOCK_BLOCK_ELEMENTS UBLOCK_BLOCK_ELEMENTS_4_0_
#undef UBLOCK_BOPOMOFO
#define UBLOCK_BOPOMOFO UBLOCK_BOPOMOFO_4_0_
#undef UBLOCK_BOPOMOFO_EXTENDED
#define UBLOCK_BOPOMOFO_EXTENDED UBLOCK_BOPOMOFO_EXTENDED_4_0_
#undef UBLOCK_BOX_DRAWING
#define UBLOCK_BOX_DRAWING UBLOCK_BOX_DRAWING_4_0_
#undef UBLOCK_BRAILLE_PATTERNS
#define UBLOCK_BRAILLE_PATTERNS UBLOCK_BRAILLE_PATTERNS_4_0_
#undef UBLOCK_BUGINESE
#define UBLOCK_BUGINESE UBLOCK_BUGINESE_4_0_
#undef UBLOCK_BUHID
#define UBLOCK_BUHID UBLOCK_BUHID_4_0_
#undef UBLOCK_BYZANTINE_MUSICAL_SYMBOLS
#define UBLOCK_BYZANTINE_MUSICAL_SYMBOLS UBLOCK_BYZANTINE_MUSICAL_SYMBOLS_4_0_
#undef UBLOCK_CARIAN
#define UBLOCK_CARIAN UBLOCK_CARIAN_4_0_
#undef UBLOCK_CHAM
#define UBLOCK_CHAM UBLOCK_CHAM_4_0_
#undef UBLOCK_CHEROKEE
#define UBLOCK_CHEROKEE UBLOCK_CHEROKEE_4_0_
#undef UBLOCK_CJK_COMPATIBILITY
#define UBLOCK_CJK_COMPATIBILITY UBLOCK_CJK_COMPATIBILITY_4_0_
#undef UBLOCK_CJK_COMPATIBILITY_FORMS
#define UBLOCK_CJK_COMPATIBILITY_FORMS UBLOCK_CJK_COMPATIBILITY_FORMS_4_0_
#undef UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS
#define UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS_4_0_
#undef UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT
#define UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT UBLOCK_CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT_4_0_
#undef UBLOCK_CJK_RADICALS_SUPPLEMENT
#define UBLOCK_CJK_RADICALS_SUPPLEMENT UBLOCK_CJK_RADICALS_SUPPLEMENT_4_0_
#undef UBLOCK_CJK_STROKES
#define UBLOCK_CJK_STROKES UBLOCK_CJK_STROKES_4_0_
#undef UBLOCK_CJK_SYMBOLS_AND_PUNCTUATION
#define UBLOCK_CJK_SYMBOLS_AND_PUNCTUATION UBLOCK_CJK_SYMBOLS_AND_PUNCTUATION_4_0_
#undef UBLOCK_CJK_UNIFIED_IDEOGRAPHS
#define UBLOCK_CJK_UNIFIED_IDEOGRAPHS UBLOCK_CJK_UNIFIED_IDEOGRAPHS_4_0_
#undef UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A
#define UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A_4_0_
#undef UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B
#define UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B_4_0_
#undef UBLOCK_COMBINING_DIACRITICAL_MARKS
#define UBLOCK_COMBINING_DIACRITICAL_MARKS UBLOCK_COMBINING_DIACRITICAL_MARKS_4_0_
#undef UBLOCK_COMBINING_DIACRITICAL_MARKS_SUPPLEMENT
#define UBLOCK_COMBINING_DIACRITICAL_MARKS_SUPPLEMENT UBLOCK_COMBINING_DIACRITICAL_MARKS_SUPPLEMENT_4_0_
#undef UBLOCK_COMBINING_HALF_MARKS
#define UBLOCK_COMBINING_HALF_MARKS UBLOCK_COMBINING_HALF_MARKS_4_0_
#undef UBLOCK_COMBINING_MARKS_FOR_SYMBOLS
#define UBLOCK_COMBINING_MARKS_FOR_SYMBOLS UBLOCK_COMBINING_MARKS_FOR_SYMBOLS_4_0_
#undef UBLOCK_CONTROL_PICTURES
#define UBLOCK_CONTROL_PICTURES UBLOCK_CONTROL_PICTURES_4_0_
#undef UBLOCK_COPTIC
#define UBLOCK_COPTIC UBLOCK_COPTIC_4_0_
#undef UBLOCK_COUNT
#define UBLOCK_COUNT UBLOCK_COUNT_4_0_
#undef UBLOCK_COUNTING_ROD_NUMERALS
#define UBLOCK_COUNTING_ROD_NUMERALS UBLOCK_COUNTING_ROD_NUMERALS_4_0_
#undef UBLOCK_CUNEIFORM
#define UBLOCK_CUNEIFORM UBLOCK_CUNEIFORM_4_0_
#undef UBLOCK_CUNEIFORM_NUMBERS_AND_PUNCTUATION
#define UBLOCK_CUNEIFORM_NUMBERS_AND_PUNCTUATION UBLOCK_CUNEIFORM_NUMBERS_AND_PUNCTUATION_4_0_
#undef UBLOCK_CURRENCY_SYMBOLS
#define UBLOCK_CURRENCY_SYMBOLS UBLOCK_CURRENCY_SYMBOLS_4_0_
#undef UBLOCK_CYPRIOT_SYLLABARY
#define UBLOCK_CYPRIOT_SYLLABARY UBLOCK_CYPRIOT_SYLLABARY_4_0_
#undef UBLOCK_CYRILLIC
#define UBLOCK_CYRILLIC UBLOCK_CYRILLIC_4_0_
#undef UBLOCK_CYRILLIC_EXTENDED_A
#define UBLOCK_CYRILLIC_EXTENDED_A UBLOCK_CYRILLIC_EXTENDED_A_4_0_
#undef UBLOCK_CYRILLIC_EXTENDED_B
#define UBLOCK_CYRILLIC_EXTENDED_B UBLOCK_CYRILLIC_EXTENDED_B_4_0_
#undef UBLOCK_CYRILLIC_SUPPLEMENT
#define UBLOCK_CYRILLIC_SUPPLEMENT UBLOCK_CYRILLIC_SUPPLEMENT_4_0_
#undef UBLOCK_CYRILLIC_SUPPLEMENTARY
#define UBLOCK_CYRILLIC_SUPPLEMENTARY UBLOCK_CYRILLIC_SUPPLEMENTARY_4_0_
#undef UBLOCK_DESERET
#define UBLOCK_DESERET UBLOCK_DESERET_4_0_
#undef UBLOCK_DEVANAGARI
#define UBLOCK_DEVANAGARI UBLOCK_DEVANAGARI_4_0_
#undef UBLOCK_DINGBATS
#define UBLOCK_DINGBATS UBLOCK_DINGBATS_4_0_
#undef UBLOCK_DOMINO_TILES
#define UBLOCK_DOMINO_TILES UBLOCK_DOMINO_TILES_4_0_
#undef UBLOCK_ENCLOSED_ALPHANUMERICS
#define UBLOCK_ENCLOSED_ALPHANUMERICS UBLOCK_ENCLOSED_ALPHANUMERICS_4_0_
#undef UBLOCK_ENCLOSED_CJK_LETTERS_AND_MONTHS
#define UBLOCK_ENCLOSED_CJK_LETTERS_AND_MONTHS UBLOCK_ENCLOSED_CJK_LETTERS_AND_MONTHS_4_0_
#undef UBLOCK_ETHIOPIC
#define UBLOCK_ETHIOPIC UBLOCK_ETHIOPIC_4_0_
#undef UBLOCK_ETHIOPIC_EXTENDED
#define UBLOCK_ETHIOPIC_EXTENDED UBLOCK_ETHIOPIC_EXTENDED_4_0_
#undef UBLOCK_ETHIOPIC_SUPPLEMENT
#define UBLOCK_ETHIOPIC_SUPPLEMENT UBLOCK_ETHIOPIC_SUPPLEMENT_4_0_
#undef UBLOCK_GENERAL_PUNCTUATION
#define UBLOCK_GENERAL_PUNCTUATION UBLOCK_GENERAL_PUNCTUATION_4_0_
#undef UBLOCK_GEOMETRIC_SHAPES
#define UBLOCK_GEOMETRIC_SHAPES UBLOCK_GEOMETRIC_SHAPES_4_0_
#undef UBLOCK_GEORGIAN
#define UBLOCK_GEORGIAN UBLOCK_GEORGIAN_4_0_
#undef UBLOCK_GEORGIAN_SUPPLEMENT
#define UBLOCK_GEORGIAN_SUPPLEMENT UBLOCK_GEORGIAN_SUPPLEMENT_4_0_
#undef UBLOCK_GLAGOLITIC
#define UBLOCK_GLAGOLITIC UBLOCK_GLAGOLITIC_4_0_
#undef UBLOCK_GOTHIC
#define UBLOCK_GOTHIC UBLOCK_GOTHIC_4_0_
#undef UBLOCK_GREEK
#define UBLOCK_GREEK UBLOCK_GREEK_4_0_
#undef UBLOCK_GREEK_EXTENDED
#define UBLOCK_GREEK_EXTENDED UBLOCK_GREEK_EXTENDED_4_0_
#undef UBLOCK_GUJARATI
#define UBLOCK_GUJARATI UBLOCK_GUJARATI_4_0_
#undef UBLOCK_GURMUKHI
#define UBLOCK_GURMUKHI UBLOCK_GURMUKHI_4_0_
#undef UBLOCK_HALFWIDTH_AND_FULLWIDTH_FORMS
#define UBLOCK_HALFWIDTH_AND_FULLWIDTH_FORMS UBLOCK_HALFWIDTH_AND_FULLWIDTH_FORMS_4_0_
#undef UBLOCK_HANGUL_COMPATIBILITY_JAMO
#define UBLOCK_HANGUL_COMPATIBILITY_JAMO UBLOCK_HANGUL_COMPATIBILITY_JAMO_4_0_
#undef UBLOCK_HANGUL_JAMO
#define UBLOCK_HANGUL_JAMO UBLOCK_HANGUL_JAMO_4_0_
#undef UBLOCK_HANGUL_SYLLABLES
#define UBLOCK_HANGUL_SYLLABLES UBLOCK_HANGUL_SYLLABLES_4_0_
#undef UBLOCK_HANUNOO
#define UBLOCK_HANUNOO UBLOCK_HANUNOO_4_0_
#undef UBLOCK_HEBREW
#define UBLOCK_HEBREW UBLOCK_HEBREW_4_0_
#undef UBLOCK_HIGH_PRIVATE_USE_SURROGATES
#define UBLOCK_HIGH_PRIVATE_USE_SURROGATES UBLOCK_HIGH_PRIVATE_USE_SURROGATES_4_0_
#undef UBLOCK_HIGH_SURROGATES
#define UBLOCK_HIGH_SURROGATES UBLOCK_HIGH_SURROGATES_4_0_
#undef UBLOCK_HIRAGANA
#define UBLOCK_HIRAGANA UBLOCK_HIRAGANA_4_0_
#undef UBLOCK_IDEOGRAPHIC_DESCRIPTION_CHARACTERS
#define UBLOCK_IDEOGRAPHIC_DESCRIPTION_CHARACTERS UBLOCK_IDEOGRAPHIC_DESCRIPTION_CHARACTERS_4_0_
#undef UBLOCK_INVALID_CODE
#define UBLOCK_INVALID_CODE UBLOCK_INVALID_CODE_4_0_
#undef UBLOCK_IPA_EXTENSIONS
#define UBLOCK_IPA_EXTENSIONS UBLOCK_IPA_EXTENSIONS_4_0_
#undef UBLOCK_KANBUN
#define UBLOCK_KANBUN UBLOCK_KANBUN_4_0_
#undef UBLOCK_KANGXI_RADICALS
#define UBLOCK_KANGXI_RADICALS UBLOCK_KANGXI_RADICALS_4_0_
#undef UBLOCK_KANNADA
#define UBLOCK_KANNADA UBLOCK_KANNADA_4_0_
#undef UBLOCK_KATAKANA
#define UBLOCK_KATAKANA UBLOCK_KATAKANA_4_0_
#undef UBLOCK_KATAKANA_PHONETIC_EXTENSIONS
#define UBLOCK_KATAKANA_PHONETIC_EXTENSIONS UBLOCK_KATAKANA_PHONETIC_EXTENSIONS_4_0_
#undef UBLOCK_KAYAH_LI
#define UBLOCK_KAYAH_LI UBLOCK_KAYAH_LI_4_0_
#undef UBLOCK_KHAROSHTHI
#define UBLOCK_KHAROSHTHI UBLOCK_KHAROSHTHI_4_0_
#undef UBLOCK_KHMER
#define UBLOCK_KHMER UBLOCK_KHMER_4_0_
#undef UBLOCK_KHMER_SYMBOLS
#define UBLOCK_KHMER_SYMBOLS UBLOCK_KHMER_SYMBOLS_4_0_
#undef UBLOCK_LAO
#define UBLOCK_LAO UBLOCK_LAO_4_0_
#undef UBLOCK_LATIN_1_SUPPLEMENT
#define UBLOCK_LATIN_1_SUPPLEMENT UBLOCK_LATIN_1_SUPPLEMENT_4_0_
#undef UBLOCK_LATIN_EXTENDED_A
#define UBLOCK_LATIN_EXTENDED_A UBLOCK_LATIN_EXTENDED_A_4_0_
#undef UBLOCK_LATIN_EXTENDED_ADDITIONAL
#define UBLOCK_LATIN_EXTENDED_ADDITIONAL UBLOCK_LATIN_EXTENDED_ADDITIONAL_4_0_
#undef UBLOCK_LATIN_EXTENDED_B
#define UBLOCK_LATIN_EXTENDED_B UBLOCK_LATIN_EXTENDED_B_4_0_
#undef UBLOCK_LATIN_EXTENDED_C
#define UBLOCK_LATIN_EXTENDED_C UBLOCK_LATIN_EXTENDED_C_4_0_
#undef UBLOCK_LATIN_EXTENDED_D
#define UBLOCK_LATIN_EXTENDED_D UBLOCK_LATIN_EXTENDED_D_4_0_
#undef UBLOCK_LEPCHA
#define UBLOCK_LEPCHA UBLOCK_LEPCHA_4_0_
#undef UBLOCK_LETTERLIKE_SYMBOLS
#define UBLOCK_LETTERLIKE_SYMBOLS UBLOCK_LETTERLIKE_SYMBOLS_4_0_
#undef UBLOCK_LIMBU
#define UBLOCK_LIMBU UBLOCK_LIMBU_4_0_
#undef UBLOCK_LINEAR_B_IDEOGRAMS
#define UBLOCK_LINEAR_B_IDEOGRAMS UBLOCK_LINEAR_B_IDEOGRAMS_4_0_
#undef UBLOCK_LINEAR_B_SYLLABARY
#define UBLOCK_LINEAR_B_SYLLABARY UBLOCK_LINEAR_B_SYLLABARY_4_0_
#undef UBLOCK_LOW_SURROGATES
#define UBLOCK_LOW_SURROGATES UBLOCK_LOW_SURROGATES_4_0_
#undef UBLOCK_LYCIAN
#define UBLOCK_LYCIAN UBLOCK_LYCIAN_4_0_
#undef UBLOCK_LYDIAN
#define UBLOCK_LYDIAN UBLOCK_LYDIAN_4_0_
#undef UBLOCK_MAHJONG_TILES
#define UBLOCK_MAHJONG_TILES UBLOCK_MAHJONG_TILES_4_0_
#undef UBLOCK_MALAYALAM
#define UBLOCK_MALAYALAM UBLOCK_MALAYALAM_4_0_
#undef UBLOCK_MATHEMATICAL_ALPHANUMERIC_SYMBOLS
#define UBLOCK_MATHEMATICAL_ALPHANUMERIC_SYMBOLS UBLOCK_MATHEMATICAL_ALPHANUMERIC_SYMBOLS_4_0_
#undef UBLOCK_MATHEMATICAL_OPERATORS
#define UBLOCK_MATHEMATICAL_OPERATORS UBLOCK_MATHEMATICAL_OPERATORS_4_0_
#undef UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A
#define UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A_4_0_
#undef UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B
#define UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B UBLOCK_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B_4_0_
#undef UBLOCK_MISCELLANEOUS_SYMBOLS
#define UBLOCK_MISCELLANEOUS_SYMBOLS UBLOCK_MISCELLANEOUS_SYMBOLS_4_0_
#undef UBLOCK_MISCELLANEOUS_SYMBOLS_AND_ARROWS
#define UBLOCK_MISCELLANEOUS_SYMBOLS_AND_ARROWS UBLOCK_MISCELLANEOUS_SYMBOLS_AND_ARROWS_4_0_
#undef UBLOCK_MISCELLANEOUS_TECHNICAL
#define UBLOCK_MISCELLANEOUS_TECHNICAL UBLOCK_MISCELLANEOUS_TECHNICAL_4_0_
#undef UBLOCK_MODIFIER_TONE_LETTERS
#define UBLOCK_MODIFIER_TONE_LETTERS UBLOCK_MODIFIER_TONE_LETTERS_4_0_
#undef UBLOCK_MONGOLIAN
#define UBLOCK_MONGOLIAN UBLOCK_MONGOLIAN_4_0_
#undef UBLOCK_MUSICAL_SYMBOLS
#define UBLOCK_MUSICAL_SYMBOLS UBLOCK_MUSICAL_SYMBOLS_4_0_
#undef UBLOCK_MYANMAR
#define UBLOCK_MYANMAR UBLOCK_MYANMAR_4_0_
#undef UBLOCK_NEW_TAI_LUE
#define UBLOCK_NEW_TAI_LUE UBLOCK_NEW_TAI_LUE_4_0_
#undef UBLOCK_NKO
#define UBLOCK_NKO UBLOCK_NKO_4_0_
#undef UBLOCK_NO_BLOCK
#define UBLOCK_NO_BLOCK UBLOCK_NO_BLOCK_4_0_
#undef UBLOCK_NUMBER_FORMS
#define UBLOCK_NUMBER_FORMS UBLOCK_NUMBER_FORMS_4_0_
#undef UBLOCK_OGHAM
#define UBLOCK_OGHAM UBLOCK_OGHAM_4_0_
#undef UBLOCK_OL_CHIKI
#define UBLOCK_OL_CHIKI UBLOCK_OL_CHIKI_4_0_
#undef UBLOCK_OLD_ITALIC
#define UBLOCK_OLD_ITALIC UBLOCK_OLD_ITALIC_4_0_
#undef UBLOCK_OLD_PERSIAN
#define UBLOCK_OLD_PERSIAN UBLOCK_OLD_PERSIAN_4_0_
#undef UBLOCK_OPTICAL_CHARACTER_RECOGNITION
#define UBLOCK_OPTICAL_CHARACTER_RECOGNITION UBLOCK_OPTICAL_CHARACTER_RECOGNITION_4_0_
#undef UBLOCK_ORIYA
#define UBLOCK_ORIYA UBLOCK_ORIYA_4_0_
#undef UBLOCK_OSMANYA
#define UBLOCK_OSMANYA UBLOCK_OSMANYA_4_0_
#undef UBLOCK_PHAGS_PA
#define UBLOCK_PHAGS_PA UBLOCK_PHAGS_PA_4_0_
#undef UBLOCK_PHAISTOS_DISC
#define UBLOCK_PHAISTOS_DISC UBLOCK_PHAISTOS_DISC_4_0_
#undef UBLOCK_PHOENICIAN
#define UBLOCK_PHOENICIAN UBLOCK_PHOENICIAN_4_0_
#undef UBLOCK_PHONETIC_EXTENSIONS
#define UBLOCK_PHONETIC_EXTENSIONS UBLOCK_PHONETIC_EXTENSIONS_4_0_
#undef UBLOCK_PHONETIC_EXTENSIONS_SUPPLEMENT
#define UBLOCK_PHONETIC_EXTENSIONS_SUPPLEMENT UBLOCK_PHONETIC_EXTENSIONS_SUPPLEMENT_4_0_
#undef UBLOCK_PRIVATE_USE
#define UBLOCK_PRIVATE_USE UBLOCK_PRIVATE_USE_4_0_
#undef UBLOCK_PRIVATE_USE_AREA
#define UBLOCK_PRIVATE_USE_AREA UBLOCK_PRIVATE_USE_AREA_4_0_
#undef UBLOCK_REJANG
#define UBLOCK_REJANG UBLOCK_REJANG_4_0_
#undef UBLOCK_RUNIC
#define UBLOCK_RUNIC UBLOCK_RUNIC_4_0_
#undef UBLOCK_SAURASHTRA
#define UBLOCK_SAURASHTRA UBLOCK_SAURASHTRA_4_0_
#undef UBLOCK_SHAVIAN
#define UBLOCK_SHAVIAN UBLOCK_SHAVIAN_4_0_
#undef UBLOCK_SINHALA
#define UBLOCK_SINHALA UBLOCK_SINHALA_4_0_
#undef UBLOCK_SMALL_FORM_VARIANTS
#define UBLOCK_SMALL_FORM_VARIANTS UBLOCK_SMALL_FORM_VARIANTS_4_0_
#undef UBLOCK_SPACING_MODIFIER_LETTERS
#define UBLOCK_SPACING_MODIFIER_LETTERS UBLOCK_SPACING_MODIFIER_LETTERS_4_0_
#undef UBLOCK_SPECIALS
#define UBLOCK_SPECIALS UBLOCK_SPECIALS_4_0_
#undef UBLOCK_SUNDANESE
#define UBLOCK_SUNDANESE UBLOCK_SUNDANESE_4_0_
#undef UBLOCK_SUPERSCRIPTS_AND_SUBSCRIPTS
#define UBLOCK_SUPERSCRIPTS_AND_SUBSCRIPTS UBLOCK_SUPERSCRIPTS_AND_SUBSCRIPTS_4_0_
#undef UBLOCK_SUPPLEMENTAL_ARROWS_A
#define UBLOCK_SUPPLEMENTAL_ARROWS_A UBLOCK_SUPPLEMENTAL_ARROWS_A_4_0_
#undef UBLOCK_SUPPLEMENTAL_ARROWS_B
#define UBLOCK_SUPPLEMENTAL_ARROWS_B UBLOCK_SUPPLEMENTAL_ARROWS_B_4_0_
#undef UBLOCK_SUPPLEMENTAL_MATHEMATICAL_OPERATORS
#define UBLOCK_SUPPLEMENTAL_MATHEMATICAL_OPERATORS UBLOCK_SUPPLEMENTAL_MATHEMATICAL_OPERATORS_4_0_
#undef UBLOCK_SUPPLEMENTAL_PUNCTUATION
#define UBLOCK_SUPPLEMENTAL_PUNCTUATION UBLOCK_SUPPLEMENTAL_PUNCTUATION_4_0_
#undef UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_A
#define UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_A UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_A_4_0_
#undef UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_B
#define UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_B UBLOCK_SUPPLEMENTARY_PRIVATE_USE_AREA_B_4_0_
#undef UBLOCK_SYLOTI_NAGRI
#define UBLOCK_SYLOTI_NAGRI UBLOCK_SYLOTI_NAGRI_4_0_
#undef UBLOCK_SYRIAC
#define UBLOCK_SYRIAC UBLOCK_SYRIAC_4_0_
#undef UBLOCK_TAGALOG
#define UBLOCK_TAGALOG UBLOCK_TAGALOG_4_0_
#undef UBLOCK_TAGBANWA
#define UBLOCK_TAGBANWA UBLOCK_TAGBANWA_4_0_
#undef UBLOCK_TAGS
#define UBLOCK_TAGS UBLOCK_TAGS_4_0_
#undef UBLOCK_TAI_LE
#define UBLOCK_TAI_LE UBLOCK_TAI_LE_4_0_
#undef UBLOCK_TAI_XUAN_JING_SYMBOLS
#define UBLOCK_TAI_XUAN_JING_SYMBOLS UBLOCK_TAI_XUAN_JING_SYMBOLS_4_0_
#undef UBLOCK_TAMIL
#define UBLOCK_TAMIL UBLOCK_TAMIL_4_0_
#undef UBLOCK_TELUGU
#define UBLOCK_TELUGU UBLOCK_TELUGU_4_0_
#undef UBLOCK_THAANA
#define UBLOCK_THAANA UBLOCK_THAANA_4_0_
#undef UBLOCK_THAI
#define UBLOCK_THAI UBLOCK_THAI_4_0_
#undef UBLOCK_TIBETAN
#define UBLOCK_TIBETAN UBLOCK_TIBETAN_4_0_
#undef UBLOCK_TIFINAGH
#define UBLOCK_TIFINAGH UBLOCK_TIFINAGH_4_0_
#undef UBLOCK_UGARITIC
#define UBLOCK_UGARITIC UBLOCK_UGARITIC_4_0_
#undef UBLOCK_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS
#define UBLOCK_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS UBLOCK_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_4_0_
#undef UBLOCK_VAI
#define UBLOCK_VAI UBLOCK_VAI_4_0_
#undef UBLOCK_VARIATION_SELECTORS
#define UBLOCK_VARIATION_SELECTORS UBLOCK_VARIATION_SELECTORS_4_0_
#undef UBLOCK_VARIATION_SELECTORS_SUPPLEMENT
#define UBLOCK_VARIATION_SELECTORS_SUPPLEMENT UBLOCK_VARIATION_SELECTORS_SUPPLEMENT_4_0_
#undef UBLOCK_VERTICAL_FORMS
#define UBLOCK_VERTICAL_FORMS UBLOCK_VERTICAL_FORMS_4_0_
#undef UBLOCK_YI_RADICALS
#define UBLOCK_YI_RADICALS UBLOCK_YI_RADICALS_4_0_
#undef UBLOCK_YI_SYLLABLES
#define UBLOCK_YI_SYLLABLES UBLOCK_YI_SYLLABLES_4_0_
#undef UBLOCK_YIJING_HEXAGRAM_SYMBOLS
#define UBLOCK_YIJING_HEXAGRAM_SYMBOLS UBLOCK_YIJING_HEXAGRAM_SYMBOLS_4_0_
#undef UBlockCode
#define UBlockCode UBlockCode_4_0_
#undef UCHAR_AGE
#define UCHAR_AGE UCHAR_AGE_4_0_
#undef UCHAR_ALPHABETIC
#define UCHAR_ALPHABETIC UCHAR_ALPHABETIC_4_0_
#undef UCHAR_ASCII_HEX_DIGIT
#define UCHAR_ASCII_HEX_DIGIT UCHAR_ASCII_HEX_DIGIT_4_0_
#undef UCHAR_BIDI_CLASS
#define UCHAR_BIDI_CLASS UCHAR_BIDI_CLASS_4_0_
#undef UCHAR_BIDI_CONTROL
#define UCHAR_BIDI_CONTROL UCHAR_BIDI_CONTROL_4_0_
#undef UCHAR_BIDI_MIRRORED
#define UCHAR_BIDI_MIRRORED UCHAR_BIDI_MIRRORED_4_0_
#undef UCHAR_BIDI_MIRRORING_GLYPH
#define UCHAR_BIDI_MIRRORING_GLYPH UCHAR_BIDI_MIRRORING_GLYPH_4_0_
#undef UCHAR_BINARY_LIMIT
#define UCHAR_BINARY_LIMIT UCHAR_BINARY_LIMIT_4_0_
#undef UCHAR_BINARY_START
#define UCHAR_BINARY_START UCHAR_BINARY_START_4_0_
#undef UCHAR_BLOCK
#define UCHAR_BLOCK UCHAR_BLOCK_4_0_
#undef UCHAR_CANONICAL_COMBINING_CLASS
#define UCHAR_CANONICAL_COMBINING_CLASS UCHAR_CANONICAL_COMBINING_CLASS_4_0_
#undef UCHAR_CASE_FOLDING
#define UCHAR_CASE_FOLDING UCHAR_CASE_FOLDING_4_0_
#undef UCHAR_CASE_SENSITIVE
#define UCHAR_CASE_SENSITIVE UCHAR_CASE_SENSITIVE_4_0_
#undef UCHAR_DASH
#define UCHAR_DASH UCHAR_DASH_4_0_
#undef UCHAR_DECOMPOSITION_TYPE
#define UCHAR_DECOMPOSITION_TYPE UCHAR_DECOMPOSITION_TYPE_4_0_
#undef UCHAR_DEFAULT_IGNORABLE_CODE_POINT
#define UCHAR_DEFAULT_IGNORABLE_CODE_POINT UCHAR_DEFAULT_IGNORABLE_CODE_POINT_4_0_
#undef UCHAR_DEPRECATED
#define UCHAR_DEPRECATED UCHAR_DEPRECATED_4_0_
#undef UCHAR_DIACRITIC
#define UCHAR_DIACRITIC UCHAR_DIACRITIC_4_0_
#undef UCHAR_DOUBLE_LIMIT
#define UCHAR_DOUBLE_LIMIT UCHAR_DOUBLE_LIMIT_4_0_
#undef UCHAR_DOUBLE_START
#define UCHAR_DOUBLE_START UCHAR_DOUBLE_START_4_0_
#undef UCHAR_EAST_ASIAN_WIDTH
#define UCHAR_EAST_ASIAN_WIDTH UCHAR_EAST_ASIAN_WIDTH_4_0_
#undef UCHAR_EXTENDER
#define UCHAR_EXTENDER UCHAR_EXTENDER_4_0_
#undef UCHAR_FULL_COMPOSITION_EXCLUSION
#define UCHAR_FULL_COMPOSITION_EXCLUSION UCHAR_FULL_COMPOSITION_EXCLUSION_4_0_
#undef UCHAR_GENERAL_CATEGORY
#define UCHAR_GENERAL_CATEGORY UCHAR_GENERAL_CATEGORY_4_0_
#undef UCHAR_GENERAL_CATEGORY_MASK
#define UCHAR_GENERAL_CATEGORY_MASK UCHAR_GENERAL_CATEGORY_MASK_4_0_
#undef UCHAR_GRAPHEME_BASE
#define UCHAR_GRAPHEME_BASE UCHAR_GRAPHEME_BASE_4_0_
#undef UCHAR_GRAPHEME_CLUSTER_BREAK
#define UCHAR_GRAPHEME_CLUSTER_BREAK UCHAR_GRAPHEME_CLUSTER_BREAK_4_0_
#undef UCHAR_GRAPHEME_EXTEND
#define UCHAR_GRAPHEME_EXTEND UCHAR_GRAPHEME_EXTEND_4_0_
#undef UCHAR_GRAPHEME_LINK
#define UCHAR_GRAPHEME_LINK UCHAR_GRAPHEME_LINK_4_0_
#undef UCHAR_HANGUL_SYLLABLE_TYPE
#define UCHAR_HANGUL_SYLLABLE_TYPE UCHAR_HANGUL_SYLLABLE_TYPE_4_0_
#undef UCHAR_HEX_DIGIT
#define UCHAR_HEX_DIGIT UCHAR_HEX_DIGIT_4_0_
#undef UCHAR_HYPHEN
#define UCHAR_HYPHEN UCHAR_HYPHEN_4_0_
#undef UCHAR_ID_CONTINUE
#define UCHAR_ID_CONTINUE UCHAR_ID_CONTINUE_4_0_
#undef UCHAR_ID_START
#define UCHAR_ID_START UCHAR_ID_START_4_0_
#undef UCHAR_IDEOGRAPHIC
#define UCHAR_IDEOGRAPHIC UCHAR_IDEOGRAPHIC_4_0_
#undef UCHAR_IDS_BINARY_OPERATOR
#define UCHAR_IDS_BINARY_OPERATOR UCHAR_IDS_BINARY_OPERATOR_4_0_
#undef UCHAR_IDS_TRINARY_OPERATOR
#define UCHAR_IDS_TRINARY_OPERATOR UCHAR_IDS_TRINARY_OPERATOR_4_0_
#undef UCHAR_INT_LIMIT
#define UCHAR_INT_LIMIT UCHAR_INT_LIMIT_4_0_
#undef UCHAR_INT_START
#define UCHAR_INT_START UCHAR_INT_START_4_0_
#undef UCHAR_INVALID_CODE
#define UCHAR_INVALID_CODE UCHAR_INVALID_CODE_4_0_
#undef UCHAR_ISO_COMMENT
#define UCHAR_ISO_COMMENT UCHAR_ISO_COMMENT_4_0_
#undef UCHAR_JOIN_CONTROL
#define UCHAR_JOIN_CONTROL UCHAR_JOIN_CONTROL_4_0_
#undef UCHAR_JOINING_GROUP
#define UCHAR_JOINING_GROUP UCHAR_JOINING_GROUP_4_0_
#undef UCHAR_JOINING_TYPE
#define UCHAR_JOINING_TYPE UCHAR_JOINING_TYPE_4_0_
#undef UCHAR_LEAD_CANONICAL_COMBINING_CLASS
#define UCHAR_LEAD_CANONICAL_COMBINING_CLASS UCHAR_LEAD_CANONICAL_COMBINING_CLASS_4_0_
#undef UCHAR_LINE_BREAK
#define UCHAR_LINE_BREAK UCHAR_LINE_BREAK_4_0_
#undef UCHAR_LOGICAL_ORDER_EXCEPTION
#define UCHAR_LOGICAL_ORDER_EXCEPTION UCHAR_LOGICAL_ORDER_EXCEPTION_4_0_
#undef UCHAR_LOWERCASE
#define UCHAR_LOWERCASE UCHAR_LOWERCASE_4_0_
#undef UCHAR_LOWERCASE_MAPPING
#define UCHAR_LOWERCASE_MAPPING UCHAR_LOWERCASE_MAPPING_4_0_
#undef UCHAR_MASK_LIMIT
#define UCHAR_MASK_LIMIT UCHAR_MASK_LIMIT_4_0_
#undef UCHAR_MASK_START
#define UCHAR_MASK_START UCHAR_MASK_START_4_0_
#undef UCHAR_MATH
#define UCHAR_MATH UCHAR_MATH_4_0_
#undef UCHAR_NAME
#define UCHAR_NAME UCHAR_NAME_4_0_
#undef UCHAR_NFC_INERT
#define UCHAR_NFC_INERT UCHAR_NFC_INERT_4_0_
#undef UCHAR_NFC_QUICK_CHECK
#define UCHAR_NFC_QUICK_CHECK UCHAR_NFC_QUICK_CHECK_4_0_
#undef UCHAR_NFD_INERT
#define UCHAR_NFD_INERT UCHAR_NFD_INERT_4_0_
#undef UCHAR_NFD_QUICK_CHECK
#define UCHAR_NFD_QUICK_CHECK UCHAR_NFD_QUICK_CHECK_4_0_
#undef UCHAR_NFKC_INERT
#define UCHAR_NFKC_INERT UCHAR_NFKC_INERT_4_0_
#undef UCHAR_NFKC_QUICK_CHECK
#define UCHAR_NFKC_QUICK_CHECK UCHAR_NFKC_QUICK_CHECK_4_0_
#undef UCHAR_NFKD_INERT
#define UCHAR_NFKD_INERT UCHAR_NFKD_INERT_4_0_
#undef UCHAR_NFKD_QUICK_CHECK
#define UCHAR_NFKD_QUICK_CHECK UCHAR_NFKD_QUICK_CHECK_4_0_
#undef UCHAR_NONCHARACTER_CODE_POINT
#define UCHAR_NONCHARACTER_CODE_POINT UCHAR_NONCHARACTER_CODE_POINT_4_0_
#undef UCHAR_NUMERIC_TYPE
#define UCHAR_NUMERIC_TYPE UCHAR_NUMERIC_TYPE_4_0_
#undef UCHAR_NUMERIC_VALUE
#define UCHAR_NUMERIC_VALUE UCHAR_NUMERIC_VALUE_4_0_
#undef UCHAR_PATTERN_SYNTAX
#define UCHAR_PATTERN_SYNTAX UCHAR_PATTERN_SYNTAX_4_0_
#undef UCHAR_PATTERN_WHITE_SPACE
#define UCHAR_PATTERN_WHITE_SPACE UCHAR_PATTERN_WHITE_SPACE_4_0_
#undef UCHAR_POSIX_ALNUM
#define UCHAR_POSIX_ALNUM UCHAR_POSIX_ALNUM_4_0_
#undef UCHAR_POSIX_BLANK
#define UCHAR_POSIX_BLANK UCHAR_POSIX_BLANK_4_0_
#undef UCHAR_POSIX_GRAPH
#define UCHAR_POSIX_GRAPH UCHAR_POSIX_GRAPH_4_0_
#undef UCHAR_POSIX_PRINT
#define UCHAR_POSIX_PRINT UCHAR_POSIX_PRINT_4_0_
#undef UCHAR_POSIX_XDIGIT
#define UCHAR_POSIX_XDIGIT UCHAR_POSIX_XDIGIT_4_0_
#undef UCHAR_QUOTATION_MARK
#define UCHAR_QUOTATION_MARK UCHAR_QUOTATION_MARK_4_0_
#undef UCHAR_RADICAL
#define UCHAR_RADICAL UCHAR_RADICAL_4_0_
#undef UCHAR_S_TERM
#define UCHAR_S_TERM UCHAR_S_TERM_4_0_
#undef UCHAR_SCRIPT
#define UCHAR_SCRIPT UCHAR_SCRIPT_4_0_
#undef UCHAR_SEGMENT_STARTER
#define UCHAR_SEGMENT_STARTER UCHAR_SEGMENT_STARTER_4_0_
#undef UCHAR_SENTENCE_BREAK
#define UCHAR_SENTENCE_BREAK UCHAR_SENTENCE_BREAK_4_0_
#undef UCHAR_SIMPLE_CASE_FOLDING
#define UCHAR_SIMPLE_CASE_FOLDING UCHAR_SIMPLE_CASE_FOLDING_4_0_
#undef UCHAR_SIMPLE_LOWERCASE_MAPPING
#define UCHAR_SIMPLE_LOWERCASE_MAPPING UCHAR_SIMPLE_LOWERCASE_MAPPING_4_0_
#undef UCHAR_SIMPLE_TITLECASE_MAPPING
#define UCHAR_SIMPLE_TITLECASE_MAPPING UCHAR_SIMPLE_TITLECASE_MAPPING_4_0_
#undef UCHAR_SIMPLE_UPPERCASE_MAPPING
#define UCHAR_SIMPLE_UPPERCASE_MAPPING UCHAR_SIMPLE_UPPERCASE_MAPPING_4_0_
#undef UCHAR_SOFT_DOTTED
#define UCHAR_SOFT_DOTTED UCHAR_SOFT_DOTTED_4_0_
#undef UCHAR_STRING_LIMIT
#define UCHAR_STRING_LIMIT UCHAR_STRING_LIMIT_4_0_
#undef UCHAR_STRING_START
#define UCHAR_STRING_START UCHAR_STRING_START_4_0_
#undef UCHAR_TERMINAL_PUNCTUATION
#define UCHAR_TERMINAL_PUNCTUATION UCHAR_TERMINAL_PUNCTUATION_4_0_
#undef UCHAR_TITLECASE_MAPPING
#define UCHAR_TITLECASE_MAPPING UCHAR_TITLECASE_MAPPING_4_0_
#undef UCHAR_TRAIL_CANONICAL_COMBINING_CLASS
#define UCHAR_TRAIL_CANONICAL_COMBINING_CLASS UCHAR_TRAIL_CANONICAL_COMBINING_CLASS_4_0_
#undef UCHAR_UNICODE_1_NAME
#define UCHAR_UNICODE_1_NAME UCHAR_UNICODE_1_NAME_4_0_
#undef UCHAR_UNIFIED_IDEOGRAPH
#define UCHAR_UNIFIED_IDEOGRAPH UCHAR_UNIFIED_IDEOGRAPH_4_0_
#undef UCHAR_UPPERCASE
#define UCHAR_UPPERCASE UCHAR_UPPERCASE_4_0_
#undef UCHAR_UPPERCASE_MAPPING
#define UCHAR_UPPERCASE_MAPPING UCHAR_UPPERCASE_MAPPING_4_0_
#undef UCHAR_VARIATION_SELECTOR
#define UCHAR_VARIATION_SELECTOR UCHAR_VARIATION_SELECTOR_4_0_
#undef UCHAR_WHITE_SPACE
#define UCHAR_WHITE_SPACE UCHAR_WHITE_SPACE_4_0_
#undef UCHAR_WORD_BREAK
#define UCHAR_WORD_BREAK UCHAR_WORD_BREAK_4_0_
#undef UCHAR_XID_CONTINUE
#define UCHAR_XID_CONTINUE UCHAR_XID_CONTINUE_4_0_
#undef UCHAR_XID_START
#define UCHAR_XID_START UCHAR_XID_START_4_0_
#undef UCharCategory
#define UCharCategory UCharCategory_4_0_
#undef UCharDirection
#define UCharDirection UCharDirection_4_0_
#undef UCharEnumTypeRange
#define UCharEnumTypeRange UCharEnumTypeRange_4_0_
#undef UCharIterator
#define UCharIterator UCharIterator_4_0_
#undef UCharIteratorCurrent
#define UCharIteratorCurrent UCharIteratorCurrent_4_0_
#undef UCharIteratorGetIndex
#define UCharIteratorGetIndex UCharIteratorGetIndex_4_0_
#undef UCharIteratorGetState
#define UCharIteratorGetState UCharIteratorGetState_4_0_
#undef UCharIteratorHasNext
#define UCharIteratorHasNext UCharIteratorHasNext_4_0_
#undef UCharIteratorHasPrevious
#define UCharIteratorHasPrevious UCharIteratorHasPrevious_4_0_
#undef UCharIteratorMove
#define UCharIteratorMove UCharIteratorMove_4_0_
#undef UCharIteratorNext
#define UCharIteratorNext UCharIteratorNext_4_0_
#undef UCharIteratorOrigin
#define UCharIteratorOrigin UCharIteratorOrigin_4_0_
#undef UCharIteratorPrevious
#define UCharIteratorPrevious UCharIteratorPrevious_4_0_
#undef UCharIteratorReserved
#define UCharIteratorReserved UCharIteratorReserved_4_0_
#undef UCharIteratorSetState
#define UCharIteratorSetState UCharIteratorSetState_4_0_
#undef UCharNameChoice
#define UCharNameChoice UCharNameChoice_4_0_
#undef UCOL_ALTERNATE_HANDLING
#define UCOL_ALTERNATE_HANDLING UCOL_ALTERNATE_HANDLING_4_0_
#undef UCOL_ATTRIBUTE_COUNT
#define UCOL_ATTRIBUTE_COUNT UCOL_ATTRIBUTE_COUNT_4_0_
#undef UCOL_ATTRIBUTE_VALUE_COUNT
#define UCOL_ATTRIBUTE_VALUE_COUNT UCOL_ATTRIBUTE_VALUE_COUNT_4_0_
#undef UCOL_BOUND_LOWER
#define UCOL_BOUND_LOWER UCOL_BOUND_LOWER_4_0_
#undef UCOL_BOUND_UPPER
#define UCOL_BOUND_UPPER UCOL_BOUND_UPPER_4_0_
#undef UCOL_BOUND_UPPER_LONG
#define UCOL_BOUND_UPPER_LONG UCOL_BOUND_UPPER_LONG_4_0_
#undef UCOL_BOUND_VALUE_COUNT
#define UCOL_BOUND_VALUE_COUNT UCOL_BOUND_VALUE_COUNT_4_0_
#undef UCOL_CASE_FIRST
#define UCOL_CASE_FIRST UCOL_CASE_FIRST_4_0_
#undef UCOL_CASE_LEVEL
#define UCOL_CASE_LEVEL UCOL_CASE_LEVEL_4_0_
#undef UCOL_CE_STRENGTH_LIMIT
#define UCOL_CE_STRENGTH_LIMIT UCOL_CE_STRENGTH_LIMIT_4_0_
#undef UCOL_DECOMPOSITION_MODE
#define UCOL_DECOMPOSITION_MODE UCOL_DECOMPOSITION_MODE_4_0_
#undef UCOL_DEFAULT
#define UCOL_DEFAULT UCOL_DEFAULT_4_0_
#undef UCOL_DEFAULT_STRENGTH
#define UCOL_DEFAULT_STRENGTH UCOL_DEFAULT_STRENGTH_4_0_
#undef UCOL_EQUAL
#define UCOL_EQUAL UCOL_EQUAL_4_0_
#undef UCOL_FRENCH_COLLATION
#define UCOL_FRENCH_COLLATION UCOL_FRENCH_COLLATION_4_0_
#undef UCOL_FULL_RULES
#define UCOL_FULL_RULES UCOL_FULL_RULES_4_0_
#undef UCOL_GREATER
#define UCOL_GREATER UCOL_GREATER_4_0_
#undef UCOL_HIRAGANA_QUATERNARY_MODE
#define UCOL_HIRAGANA_QUATERNARY_MODE UCOL_HIRAGANA_QUATERNARY_MODE_4_0_
#undef UCOL_IDENTICAL
#define UCOL_IDENTICAL UCOL_IDENTICAL_4_0_
#undef UCOL_LESS
#define UCOL_LESS UCOL_LESS_4_0_
#undef UCOL_LOWER_FIRST
#define UCOL_LOWER_FIRST UCOL_LOWER_FIRST_4_0_
#undef UCOL_NON_IGNORABLE
#define UCOL_NON_IGNORABLE UCOL_NON_IGNORABLE_4_0_
#undef UCOL_NORMALIZATION_MODE
#define UCOL_NORMALIZATION_MODE UCOL_NORMALIZATION_MODE_4_0_
#undef UCOL_NUMERIC_COLLATION
#define UCOL_NUMERIC_COLLATION UCOL_NUMERIC_COLLATION_4_0_
#undef UCOL_OFF
#define UCOL_OFF UCOL_OFF_4_0_
#undef UCOL_ON
#define UCOL_ON UCOL_ON_4_0_
#undef UCOL_PRIMARY
#define UCOL_PRIMARY UCOL_PRIMARY_4_0_
#undef UCOL_QUATERNARY
#define UCOL_QUATERNARY UCOL_QUATERNARY_4_0_
#undef UCOL_SECONDARY
#define UCOL_SECONDARY UCOL_SECONDARY_4_0_
#undef UCOL_SHIFTED
#define UCOL_SHIFTED UCOL_SHIFTED_4_0_
#undef UCOL_STRENGTH
#define UCOL_STRENGTH UCOL_STRENGTH_4_0_
#undef UCOL_STRENGTH_LIMIT
#define UCOL_STRENGTH_LIMIT UCOL_STRENGTH_LIMIT_4_0_
#undef UCOL_TAILORING_ONLY
#define UCOL_TAILORING_ONLY UCOL_TAILORING_ONLY_4_0_
#undef UCOL_TERTIARY
#define UCOL_TERTIARY UCOL_TERTIARY_4_0_
#undef UCOL_UPPER_FIRST
#define UCOL_UPPER_FIRST UCOL_UPPER_FIRST_4_0_
#undef UColAttribute
#define UColAttribute UColAttribute_4_0_
#undef UColAttributeValue
#define UColAttributeValue UColAttributeValue_4_0_
#undef UColBoundMode
#define UColBoundMode UColBoundMode_4_0_
#undef UCollationResult
#define UCollationResult UCollationResult_4_0_
#undef UCollationStrength
#define UCollationStrength UCollationStrength_4_0_
#undef UColRuleOption
#define UColRuleOption UColRuleOption_4_0_
#undef UDecompositionType
#define UDecompositionType UDecompositionType_4_0_
#undef UEastAsianWidth
#define UEastAsianWidth UEastAsianWidth_4_0_
#undef UEnumCharNamesFn
#define UEnumCharNamesFn UEnumCharNamesFn_4_0_
#undef UErrorCode
#define UErrorCode UErrorCode_4_0_
#undef UFieldPosition
#define UFieldPosition UFieldPosition_4_0_
#undef UGraphemeClusterBreak
#define UGraphemeClusterBreak UGraphemeClusterBreak_4_0_
#undef UHangulSyllableType
#define UHangulSyllableType UHangulSyllableType_4_0_
#undef UITER_CURRENT
#define UITER_CURRENT UITER_CURRENT_4_0_
#undef UITER_LENGTH
#define UITER_LENGTH UITER_LENGTH_4_0_
#undef UITER_LIMIT
#define UITER_LIMIT UITER_LIMIT_4_0_
#undef UITER_START
#define UITER_START UITER_START_4_0_
#undef UITER_UNKNOWN_INDEX
#define UITER_UNKNOWN_INDEX UITER_UNKNOWN_INDEX_4_0_
#undef UITER_ZERO
#define UITER_ZERO UITER_ZERO_4_0_
#undef UJoiningGroup
#define UJoiningGroup UJoiningGroup_4_0_
#undef UJoiningType
#define UJoiningType UJoiningType_4_0_
#undef ULayoutType
#define ULayoutType ULayoutType_4_0_
#undef ULineBreak
#define ULineBreak ULineBreak_4_0_
#undef ULOC_ACCEPT_FAILED
#define ULOC_ACCEPT_FAILED ULOC_ACCEPT_FAILED_4_0_
#undef ULOC_ACCEPT_FALLBACK
#define ULOC_ACCEPT_FALLBACK ULOC_ACCEPT_FALLBACK_4_0_
#undef ULOC_ACCEPT_VALID
#define ULOC_ACCEPT_VALID ULOC_ACCEPT_VALID_4_0_
#undef ULOC_ACTUAL_LOCALE
#define ULOC_ACTUAL_LOCALE ULOC_ACTUAL_LOCALE_4_0_
#undef ULOC_DATA_LOCALE_TYPE_LIMIT
#define ULOC_DATA_LOCALE_TYPE_LIMIT ULOC_DATA_LOCALE_TYPE_LIMIT_4_0_
#undef ULOC_LAYOUT_BTT
#define ULOC_LAYOUT_BTT ULOC_LAYOUT_BTT_4_0_
#undef ULOC_LAYOUT_LTR
#define ULOC_LAYOUT_LTR ULOC_LAYOUT_LTR_4_0_
#undef ULOC_LAYOUT_RTL
#define ULOC_LAYOUT_RTL ULOC_LAYOUT_RTL_4_0_
#undef ULOC_LAYOUT_TTB
#define ULOC_LAYOUT_TTB ULOC_LAYOUT_TTB_4_0_
#undef ULOC_LAYOUT_UNKNOWN
#define ULOC_LAYOUT_UNKNOWN ULOC_LAYOUT_UNKNOWN_4_0_
#undef ULOC_REQUESTED_LOCALE
#define ULOC_REQUESTED_LOCALE ULOC_REQUESTED_LOCALE_4_0_
#undef ULOC_VALID_LOCALE
#define ULOC_VALID_LOCALE ULOC_VALID_LOCALE_4_0_
#undef ULocDataLocaleType
#define ULocDataLocaleType ULocDataLocaleType_4_0_
#undef UNORM_DEFAULT
#define UNORM_DEFAULT UNORM_DEFAULT_4_0_
#undef UNORM_FCD
#define UNORM_FCD UNORM_FCD_4_0_
#undef UNORM_MAYBE
#define UNORM_MAYBE UNORM_MAYBE_4_0_
#undef UNORM_MODE_COUNT
#define UNORM_MODE_COUNT UNORM_MODE_COUNT_4_0_
#undef UNORM_NFC
#define UNORM_NFC UNORM_NFC_4_0_
#undef UNORM_NFD
#define UNORM_NFD UNORM_NFD_4_0_
#undef UNORM_NFKC
#define UNORM_NFKC UNORM_NFKC_4_0_
#undef UNORM_NFKD
#define UNORM_NFKD UNORM_NFKD_4_0_
#undef UNORM_NO
#define UNORM_NO UNORM_NO_4_0_
#undef UNORM_NONE
#define UNORM_NONE UNORM_NONE_4_0_
#undef UNORM_UNICODE_3_2
#define UNORM_UNICODE_3_2 UNORM_UNICODE_3_2_4_0_
#undef UNORM_YES
#define UNORM_YES UNORM_YES_4_0_
#undef UNORM2_COMPOSE
#define UNORM2_COMPOSE UNORM2_COMPOSE_4_0_
#undef UNORM2_COMPOSE_CONTIGUOUS
#define UNORM2_COMPOSE_CONTIGUOUS UNORM2_COMPOSE_CONTIGUOUS_4_0_
#undef UNORM2_DECOMPOSE
#define UNORM2_DECOMPOSE UNORM2_DECOMPOSE_4_0_
#undef UNORM2_FCD
#define UNORM2_FCD UNORM2_FCD_4_0_
#undef UNormalization2Mode
#define UNormalization2Mode UNormalization2Mode_4_0_
#undef UNormalizationCheckResult
#define UNormalizationCheckResult UNormalizationCheckResult_4_0_
#undef UNormalizationMode
#define UNormalizationMode UNormalizationMode_4_0_
#undef UNumericType
#define UNumericType UNumericType_4_0_
#undef UParseError
#define UParseError UParseError_4_0_
#undef UProperty
#define UProperty UProperty_4_0_
#undef UPropertyNameChoice
#define UPropertyNameChoice UPropertyNameChoice_4_0_
#undef URegistryKey
#define URegistryKey URegistryKey_4_0_
#undef USentenceBreak
#define USentenceBreak USentenceBreak_4_0_
#undef USerializedSet
#define USerializedSet USerializedSet_4_0_
#undef USET_ADD_CASE_MAPPINGS
#define USET_ADD_CASE_MAPPINGS USET_ADD_CASE_MAPPINGS_4_0_
#undef USET_CASE_INSENSITIVE
#define USET_CASE_INSENSITIVE USET_CASE_INSENSITIVE_4_0_
#undef USET_IGNORE_SPACE
#define USET_IGNORE_SPACE USET_IGNORE_SPACE_4_0_
#undef USET_SERIALIZED_STATIC_ARRAY_CAPACITY
#define USET_SERIALIZED_STATIC_ARRAY_CAPACITY USET_SERIALIZED_STATIC_ARRAY_CAPACITY_4_0_
#undef USET_SPAN_CONDITION_COUNT
#define USET_SPAN_CONDITION_COUNT USET_SPAN_CONDITION_COUNT_4_0_
#undef USET_SPAN_CONTAINED
#define USET_SPAN_CONTAINED USET_SPAN_CONTAINED_4_0_
#undef USET_SPAN_NOT_CONTAINED
#define USET_SPAN_NOT_CONTAINED USET_SPAN_NOT_CONTAINED_4_0_
#undef USET_SPAN_SIMPLE
#define USET_SPAN_SIMPLE USET_SPAN_SIMPLE_4_0_
#undef USetSpanCondition
#define USetSpanCondition USetSpanCondition_4_0_
#undef UWordBreakValues
#define UWordBreakValues UWordBreakValues_4_0_
#undef CharacterIterator
#define CharacterIterator CharacterIterator_4_0_
#undef Replaceable
#define Replaceable Replaceable_4_0_

#undef UnicodeString
#define UnicodeString UnicodeString_4_0_
