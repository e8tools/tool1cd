...
#if defined (_MSC_VER)
		wcsncpy_s(str1, 2*(imaxlen - 1), str2, imaxlen - 1);
#else
...
#if defined (_MSC_VER)
		wcscpy_s(str1, 2 * (imaxlen - 1), str2);
#else
		wcscpy(str1,str2);
#endif
...
#if defined (_MSC_VER)
		wcsncpy_s(str1 + l1, 2*(imaxlen - 1 - l1),str2, imaxlen - 1 - l1);
#else
...
#if defined (_MSC_VER)
		wcscat_s(str1, 2*(imaxlen - 1), str2);
#else
		wcscat(str1, str2);
#endif
